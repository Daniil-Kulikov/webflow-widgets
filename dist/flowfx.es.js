...
function me(e, t, n, r) {
	return pe(e, t, 1 - Math.exp(-n * r));
}
function he(e, t = 1) {
	return t - Math.abs(ue(e, t * 2) - t);
}
function ge(e, t, n) {
...
var Ae = {
	...
	ceilPowerOfTwo: Te,
	floorPowerOfTwo: Ee,
	setQuaternionFromProperEuler: De,
	normalize: ke,
	denormalize: Oe
}, U = class e {
	static {
	...
	*[Symbol.iterator]() {
...
}, G = /*@__PURE__*/ new W(), Me = /*@__PURE__*/ new je(), K = class e {
	static {
	...
	scale(e, t) {
		return re("Matrix3: .scale() is deprecated. Use .makeScale() instead."), this.premultiply(Ne.makeScale(e, t)), this;
	}
	rotate(e) {
		return re("Matrix3: .rotate() is deprecated. Use .makeRotation() instead."), this.premultiply(Ne.makeRotation(-e)), this;
	}
	translate(e, t) {
		return re("Matrix3: .translate() is deprecated. Use .makeTranslation() instead."), this.premultiply(Ne.makeTranslation(e, t)), this;
	}
	makeTranslation(e, t) {
...
}, Ne = /*@__PURE__*/ new K(), q = /*@__PURE__*/ new K().set(.4123908, .3575843, .1804808, .212639, .7151687, .0721923, .0193308, .1191948, .9505322), Pe = /*@__PURE__*/ new K().set(3.2409699, -1.5373832, -.4986108, -.9692436, 1.8759675, .0415551, .0556301, -.203977, 1.0569715);
function J() {
	let e = {
		enabled: !0,
		workingColorSpace: k,
		...
		convert: function(e, t, n) {
			return this.enabled === !1 || t === n || !t || !n ? e : (this.spaces[t].transfer === "srgb" && (e.r = X(e.r), e.g = X(e.g), e.b = X(e.b)), this.spaces[t].primaries !== this.spaces[n].primaries && (e.applyMatrix3(this.spaces[t].toXYZ), e.applyMatrix3(this.spaces[n].fromXYZ)), this.spaces[n].transfer === "srgb" && (e.r = Fe(e.r), e.g = Fe(e.g), e.b = Fe(e.b)), e);
		},
...
var Ie, Le = class {
	static getDataURL(e, t = "image/png") {
		...
		if (e instanceof HTMLCanvasElement) n = e;
			...
			Ie === void 0 && (Ie = I("canvas")), Ie.width = e.width, Ie.height = e.height;
			let t = Ie.getContext("2d");
			e instanceof ImageData ? t.putImageData(e, 0, 0) : t.drawImage(e, 0, 0, e.width, e.height), n = Ie;
		}
	...
	static sRGBToLinear(e) {
		if (typeof HTMLImageElement < "u" && e instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && e instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && e instanceof ImageBitmap) {
			...
			for (let e = 0; e < i.length; e++) i[e] = X(i[e] / 255) * 255;
			return n.putImageData(r, 0, 0), t;
		} else if (e.data) {
			let t = e.data.slice(0);
			for (let e = 0; e < t.length; e++) t instanceof Uint8Array || t instanceof Uint8ClampedArray ? t[e] = Math.floor(X(t[e] / 255) * 255) : t[e] = X(t[e]);
			return {
				data: t,
				width: e.width,
				height: e.height
			};
		} else return R("ImageUtils.sRGBToLinear(): Unsupported image type. No color space conversion applied."), e;
	}
}, Re = 0, ze = class {
	constructor(e = null) {
		this.isSource = !0, Object.defineProperty(this, "id", { value: Re++ }), this.uuid = V(), this.data = e, this.dataReady = !0, this.version = 0;
	}
	getSize(e) {
		let t = this.data;
	...
	toJSON(e) {
		...
		if (r !== null) {
			...
			if (Array.isArray(r)) {
				e = [];
				for (let t = 0, n = r.length; t < n; t++) r[t].isDataTexture ? e.push(Be(r[t].image)) : e.push(Be(r[t]));
			} else e = Be(r);
			n.url = e;
		}
...
function Be(e) {
	return typeof HTMLImageElement < "u" && e instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && e instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && e instanceof ImageBitmap ? Le.getDataURL(e) : e.data ? {
...
Ue.DEFAULT_IMAGE = null, Ue.DEFAULT_MAPPING = 300, Ue.DEFAULT_ANISOTROPY = 1;
var We = class e {
	static {
	...
	*[Symbol.iterator]() {
	...
	constructor(e = 1, t = 1, n = {}) {
		...
		}, n), this.isRenderTarget = !0, this.width = e, this.height = t, this.depth = n.depth, this.scissor = new We(0, 0, e, t), this.scissorTest = !1, this.viewport = new We(0, 0, e, t), this.textures = [];
		let r = new Ue({
			width: e,
			height: t,
			depth: n.depth
	...
	copy(e) {
		...
		for (let t = 0, n = e.textures.length; t < n; t++) {
			...
			this.textures[t].source = new ze(n);
		}
	...
	extractRotation(e) {
		...
		let t = this.elements, n = e.elements, r = 1 / Xe.setFromMatrixColumn(e, 0).length(), i = 1 / Xe.setFromMatrixColumn(e, 1).length(), a = 1 / Xe.setFromMatrixColumn(e, 2).length();
	...
	makeRotationFromQuaternion(e) {
		return this.compose(Qe, e, $e);
	}
	lookAt(e, t, n) {
		let r = this.elements;
		return nt.subVectors(e, t), nt.lengthSq() === 0 && (nt.z = 1), nt.normalize(), et.crossVectors(n, nt), et.lengthSq() === 0 && (Math.abs(n.z) === 1 ? nt.x += 1e-4 : nt.z += 1e-4, nt.normalize(), et.crossVectors(n, nt)), et.normalize(), tt.crossVectors(nt, et), r[0] = et.x, r[4] = tt.x, r[8] = nt.x, r[1] = et.y, r[5] = tt.y, r[9] = nt.y, r[2] = et.z, r[6] = tt.z, r[10] = nt.z, this;
	}
	multiply(e) {
		return this.multiplyMatrices(this, e);
	}
	...
	decompose(e, t, n) {
		...
		let a = Xe.set(r[0], r[1], r[2]).length(), o = Xe.set(r[4], r[5], r[6]).length(), s = Xe.set(r[8], r[9], r[10]).length();
...
}, Xe = /*@__PURE__*/ new W(), Ze = /*@__PURE__*/ new Ye(), Qe = /*@__PURE__*/ new W(0, 0, 0), $e = /*@__PURE__*/ new W(1, 1, 1), et = /*@__PURE__*/ new W(), tt = /*@__PURE__*/ new W(), nt = /*@__PURE__*/ new W(), rt = /*@__PURE__*/ new Ye(), it = /*@__PURE__*/ new je(), at = class e {
	...
	setFromQuaternion(e, t, n) {
		return rt.makeRotationFromQuaternion(e), this.setFromRotationMatrix(rt, t, n);
	}
...
var ot = class {
...
}, st = 0, ct = /*@__PURE__*/ new W(), lt = /*@__PURE__*/ new je(), ut = /*@__PURE__*/ new Ye(), dt = /*@__PURE__*/ new W(), ft = /*@__PURE__*/ new W(), pt = /*@__PURE__*/ new W(), mt = /*@__PURE__*/ new je(), ht = /*@__PURE__*/ new W(1, 0, 0), gt = /*@__PURE__*/ new W(0, 1, 0), _t = /*@__PURE__*/ new W(0, 0, 1), vt = { type: "added" }, yt = { type: "removed" }, bt = {
	type: "childadded",
	child: null
}, xt = {
	type: "childremoved",
	child: null
}, St = class e extends oe {
	constructor() {
		super(), this.isObject3D = !0, Object.defineProperty(this, "id", { value: st++ }), this.uuid = V(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = e.DEFAULT_UP.clone();
		let t = new W(), n = new at(), r = new je(), i = new W(1, 1, 1);
		function a() {
			r.setFromEuler(n, !1);
		}
		function o() {
	...
	rotateOnAxis(e, t) {
		return lt.setFromAxisAngle(e, t), this.quaternion.multiply(lt), this;
	}
	rotateOnWorldAxis(e, t) {
		return lt.setFromAxisAngle(e, t), this.quaternion.premultiply(lt), this;
	}
	rotateX(e) {
		return this.rotateOnAxis(ht, e);
	}
	rotateY(e) {
	...
	translateX(e) {
		return this.translateOnAxis(ht, e);
	}
	translateY(e) {
	...
	worldToLocal(e) {
		return this.updateWorldMatrix(!0, !1), e.applyMatrix4(ut.copy(this.matrixWorld).invert());
	}
	lookAt(e, t, n) {
		e.isVector3 ? dt.copy(e) : dt.set(e, t, n);
		let r = this.parent;
		this.updateWorldMatrix(!0, !1), ft.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? ut.lookAt(ft, dt, this.up) : ut.lookAt(dt, ft, this.up), this.quaternion.setFromRotationMatrix(ut), r && (ut.extractRotation(r.matrixWorld), lt.setFromRotationMatrix(ut), this.quaternion.premultiply(lt.invert()));
	}
	add(e) {
		...
		return e === this ? (z("Object3D.add: object can't be added as a child of itself.", e), this) : (e && e.isObject3D ? (e.removeFromParent(), e.parent = this, this.children.push(e), e.dispatchEvent(vt), bt.child = e, this.dispatchEvent(bt), bt.child = null) : z("Object3D.add: object not an instance of THREE.Object3D.", e), this);
	}
	remove(e) {
		if (arguments.length > 1) {
		...
		return t !== -1 && (e.parent = null, this.children.splice(t, 1), e.dispatchEvent(yt), xt.child = e, this.dispatchEvent(xt), xt.child = null), this;
	}
	removeFromParent() {
		let e = this.parent;
	...
	attach(e) {
		return this.updateWorldMatrix(!0, !1), ut.copy(this.matrixWorld).invert(), e.parent !== null && (e.parent.updateWorldMatrix(!0, !1), ut.multiply(e.parent.matrixWorld)), e.applyMatrix4(ut), e.removeFromParent(), e.parent = this, this.children.push(e), e.updateWorldMatrix(!1, !0), e.dispatchEvent(vt), bt.child = e, this.dispatchEvent(bt), bt.child = null, this;
	}
	getObjectById(e) {
	...
	getWorldQuaternion(e) {
		return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(ft, e, pt), e;
	}
	getWorldScale(e) {
		return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(ft, mt, e), e;
	}
	getWorldDirection(e) {
...
St.DEFAULT_UP = /*@__PURE__*/ new W(0, 1, 0), St.DEFAULT_MATRIX_AUTO_UPDATE = !0, St.DEFAULT_MATRIX_WORLD_AUTO_UPDATE = !0;
var Ct = class extends St {
	constructor() {
		super(), this.isGroup = !0, this.type = "Group";
	}
}, wt = { type: "move" }, Tt = class {
	constructor() {
	...
	getTargetRaySpace() {
		return this._targetRay === null && (this._targetRay = new Ct(), this._targetRay.matrixAutoUpdate = !1, this._targetRay.visible = !1, this._targetRay.hasLinearVelocity = !1, this._targetRay.linearVelocity = new W(), this._targetRay.hasAngularVelocity = !1, this._targetRay.angularVelocity = new W()), this._targetRay;
	}
	getGripSpace() {
		return this._grip === null && (this._grip = new Ct(), this._grip.matrixAutoUpdate = !1, this._grip.visible = !1, this._grip.hasLinearVelocity = !1, this._grip.linearVelocity = new W(), this._grip.hasAngularVelocity = !1, this._grip.angularVelocity = new W(), this._grip.eventsEnabled = !1), this._grip;
	}
	dispatchEvent(e) {
	...
	update(e, t, n) {
		...
		if (e && t.session.visibilityState !== "visible-blurred") {
			...
			o !== null && (r = t.getPose(e.targetRaySpace, n), r === null && i !== null && (r = i), r !== null && (o.matrix.fromArray(r.transform.matrix), o.matrix.decompose(o.position, o.rotation, o.scale), o.matrixWorldNeedsUpdate = !0, r.linearVelocity ? (o.hasLinearVelocity = !0, o.linearVelocity.copy(r.linearVelocity)) : o.hasLinearVelocity = !1, r.angularVelocity ? (o.hasAngularVelocity = !0, o.angularVelocity.copy(r.angularVelocity)) : o.hasAngularVelocity = !1, this.dispatchEvent(wt)));
		}
...
var Z = class {
	...
	setHSL(e, t, n, r = Y.workingColorSpace) {
		if (e = ue(e, 1), t = H(t, 0, 1), n = H(n, 0, 1), t === 0) this.r = this.g = this.b = n;
		else {
			let r = n <= .5 ? n * (1 + t) : n + t - n * t, i = 2 * n - r;
			this.r = kt(i, r, e + 1 / 3), this.g = kt(i, r, e), this.b = kt(i, r, e - 1 / 3);
		}
	...
	copySRGBToLinear(e) {
		return this.r = X(e.r), this.g = X(e.g), this.b = X(e.b), this;
	}
	copyLinearToSRGB(e) {
	...
	getHex(e = O) {
		return Y.workingToColorSpace(At.copy(this), e), Math.round(H(At.r * 255, 0, 255)) * 65536 + Math.round(H(At.g * 255, 0, 255)) * 256 + Math.round(H(At.b * 255, 0, 255));
	}
	getHexString(e = O) {
		return ("000000" + this.getHex(e).toString(16)).slice(-6);
	}
	getHSL(e, t = Y.workingColorSpace) {
		Y.workingToColorSpace(At.copy(this), t);
		let n = At.r, r = At.g, i = At.b, a = Math.max(n, r, i), o = Math.min(n, r, i), s, c, l = (o + a) / 2;
		if (o === a) s = 0, c = 0;
		else {
			let e = a - o;
	...
	getRGB(e, t = Y.workingColorSpace) {
		return Y.workingToColorSpace(At.copy(this), t), e.r = At.r, e.g = At.g, e.b = At.b, e;
	}
	getStyle(e = O) {
		Y.workingToColorSpace(At.copy(this), e);
		let t = At.r, n = At.g, r = At.b;
	...
	lerpHSL(e, t) {
		this.getHSL(Dt), e.getHSL(Ot);
		let n = pe(Dt.h, Ot.h, t), r = pe(Dt.s, Ot.s, t), i = pe(Dt.l, Ot.l, t);
...
var jt = class extends St {
...
}, Mt = /*@__PURE__*/ new W(), Nt = /*@__PURE__*/ new W(), Pt = /*@__PURE__*/ new W(), Ft = /*@__PURE__*/ new W(), It = /*@__PURE__*/ new W(), Lt = /*@__PURE__*/ new W(), Rt = /*@__PURE__*/ new W(), zt = /*@__PURE__*/ new W(), Bt = /*@__PURE__*/ new W(), Vt = /*@__PURE__*/ new W(), Ht = /*@__PURE__*/ new We(), Ut = /*@__PURE__*/ new We(), Wt = /*@__PURE__*/ new We(), Gt = class e {
	...
	static getBarycoord(e, t, n, r, i) {
		Mt.subVectors(r, t), Nt.subVectors(n, t), Pt.subVectors(e, t);
		let a = Mt.dot(Mt), o = Mt.dot(Nt), s = Mt.dot(Pt), c = Nt.dot(Nt), l = Nt.dot(Pt), u = a * c - o * o;
		if (u === 0) return i.set(0, 0, 0), null;
		let d = 1 / u, f = (c * s - o * l) * d, p = (a * l - o * s) * d;
		return i.set(1 - f - p, p, f);
	}
	static containsPoint(e, t, n, r) {
		return this.getBarycoord(e, t, n, r, Ft) === null ? !1 : Ft.x >= 0 && Ft.y >= 0 && Ft.x + Ft.y <= 1;
	}
	static getInterpolation(e, t, n, r, i, a, o, s) {
		return this.getBarycoord(e, t, n, r, Ft) === null ? (s.x = 0, s.y = 0, "z" in s && (s.z = 0), "w" in s && (s.w = 0), null) : (s.setScalar(0), s.addScaledVector(i, Ft.x), s.addScaledVector(a, Ft.y), s.addScaledVector(o, Ft.z), s);
	}
	static getInterpolatedAttribute(e, t, n, r, i, a) {
		return Ht.setScalar(0), Ut.setScalar(0), Wt.setScalar(0), Ht.fromBufferAttribute(e, t), Ut.fromBufferAttribute(e, n), Wt.fromBufferAttribute(e, r), a.setScalar(0), a.addScaledVector(Ht, i.x), a.addScaledVector(Ut, i.y), a.addScaledVector(Wt, i.z), a;
	}
	static isFrontFacing(e, t, n, r) {
		return Mt.subVectors(n, t), Nt.subVectors(e, t), Mt.cross(Nt).dot(r) < 0;
	}
	set(e, t, n) {
	...
	getArea() {
		return Mt.subVectors(this.c, this.b), Nt.subVectors(this.a, this.b), Mt.cross(Nt).length() * .5;
	}
	getMidpoint(e) {
	...
	closestPointToPoint(e, t) {
		...
		It.subVectors(r, n), Lt.subVectors(i, n), zt.subVectors(e, n);
		let s = It.dot(zt), c = Lt.dot(zt);
		if (s <= 0 && c <= 0) return t.copy(n);
		Bt.subVectors(e, r);
		let l = It.dot(Bt), u = Lt.dot(Bt);
		if (l >= 0 && u <= l) return t.copy(r);
		let d = s * u - l * c;
		if (d <= 0 && s >= 0 && l <= 0) return a = s / (s - l), t.copy(n).addScaledVector(It, a);
		Vt.subVectors(e, i);
		let f = It.dot(Vt), p = Lt.dot(Vt);
		if (p >= 0 && f <= p) return t.copy(i);
		let m = f * c - s * p;
		if (m <= 0 && c >= 0 && p <= 0) return o = c / (c - p), t.copy(n).addScaledVector(Lt, o);
		let h = l * p - f * u;
		if (h <= 0 && u - l >= 0 && f - p >= 0) return Rt.subVectors(i, r), o = (u - l) / (u - l + (f - p)), t.copy(r).addScaledVector(Rt, o);
		let g = 1 / (h + m + d);
		return a = m * g, o = d * g, t.copy(n).addScaledVector(It, a).addScaledVector(Lt, o);
	}
	equals(e) {
	...
	expandByObject(e, t = !1) {
		...
		if (n !== void 0) {
			...
			else e.boundingBox === void 0 ? (n.boundingBox === null && n.computeBoundingBox(), Yt.copy(n.boundingBox)) : (e.boundingBox === null && e.computeBoundingBox(), Yt.copy(e.boundingBox)), Yt.applyMatrix4(e.matrixWorld), this.union(Yt);
		}
		let r = e.children;
	...
	intersectsTriangle(e) {
		...
		this.getCenter(nn), rn.subVectors(this.max, nn), Xt.subVectors(e.a, nn), Zt.subVectors(e.b, nn), Qt.subVectors(e.c, nn), $t.subVectors(Zt, Xt), en.subVectors(Qt, Zt), tn.subVectors(Xt, Qt);
		let t = [
			0,
			-$t.z,
			$t.y,
		...
		return !sn(t, Xt, Zt, Qt, rn) || (t = [
			...
			0,
			1
		], !sn(t, Xt, Zt, Qt, rn)) ? !1 : (an.crossVectors($t, en), t = [
			an.x,
			an.y,
			an.z
		], sn(t, Xt, Zt, Qt, rn));
	...
	/*@__PURE__*/ new W(),
	/*@__PURE__*/ new W()
], Jt = /*@__PURE__*/ new W(), Yt = /*@__PURE__*/ new Kt(), Xt = /*@__PURE__*/ new W(), Zt = /*@__PURE__*/ new W(), Qt = /*@__PURE__*/ new W(), $t = /*@__PURE__*/ new W(), en = /*@__PURE__*/ new W(), tn = /*@__PURE__*/ new W(), nn = /*@__PURE__*/ new W(), rn = /*@__PURE__*/ new W(), an = /*@__PURE__*/ new W(), on = /*@__PURE__*/ new W();
function sn(e, t, n, r, i) {
	for (let a = 0, o = e.length - 3; a <= o; a += 3) {
		on.fromArray(e, a);
		let o = i.x * Math.abs(on.x) + i.y * Math.abs(on.y) + i.z * Math.abs(on.z), s = t.dot(on), c = n.dot(on), l = r.dot(on);
		if (Math.max(-Math.max(s, c, l), Math.min(s, c, l)) > o) return !1;
	}
	return !0;
}
var cn = /*@__PURE__*/ new W(), ln = /*@__PURE__*/ new U(), un = 0, dn = class extends oe {
	constructor(e, t, n = !1) {
		if (super(), Array.isArray(e)) throw TypeError("THREE.BufferAttribute: array should be a Typed Array.");
		this.isBufferAttribute = !0, Object.defineProperty(this, "id", { value: un++ }), this.name = "", this.array = e, this.itemSize = t, this.count = e === void 0 ? 0 : e.length / t, this.normalized = n, this.usage = 35044, this.updateRanges = [], this.gpuType = l, this.version = 0;
	}
	onUploadCallback() {}
	set needsUpdate(e) {
		e === !0 && this.version++;
	...
	applyMatrix3(e) {
		if (this.itemSize === 2) for (let t = 0, n = this.count; t < n; t++) ln.fromBufferAttribute(this, t), ln.applyMatrix3(e), this.setXY(t, ln.x, ln.y);
		else if (this.itemSize === 3) for (let t = 0, n = this.count; t < n; t++) cn.fromBufferAttribute(this, t), cn.applyMatrix3(e), this.setXYZ(t, cn.x, cn.y, cn.z);
		return this;
	}
	applyMatrix4(e) {
		for (let t = 0, n = this.count; t < n; t++) cn.fromBufferAttribute(this, t), cn.applyMatrix4(e), this.setXYZ(t, cn.x, cn.y, cn.z);
		return this;
	}
	applyNormalMatrix(e) {
		for (let t = 0, n = this.count; t < n; t++) cn.fromBufferAttribute(this, t), cn.applyNormalMatrix(e), this.setXYZ(t, cn.x, cn.y, cn.z);
		return this;
	}
	transformDirection(e) {
		for (let t = 0, n = this.count; t < n; t++) cn.fromBufferAttribute(this, t), cn.transformDirection(e), this.setXYZ(t, cn.x, cn.y, cn.z);
		return this;
	}
	set(e, t = 0) {
	...
	getComponent(e, t) {
		...
		return this.normalized && (n = Oe(n, this.array)), n;
	}
	setComponent(e, t, n) {
	...
	setXYZW(e, t, n, r, i) {
		return e *= this.itemSize, this.normalized && (t = ke(t, this.array), n = ke(n, this.array), r = ke(r, this.array), i = ke(i, this.array)), this.array[e + 0] = t, this.array[e + 1] = n, this.array[e + 2] = r, this.array[e + 3] = i, this;
	}
	onUpload(e) {
...
}, hn = /*@__PURE__*/ new Kt(), gn = /*@__PURE__*/ new W(), _n = /*@__PURE__*/ new W(), vn = class {
	...
	setFromPoints(e, t) {
		let n = this.center;
		t === void 0 ? hn.setFromPoints(e).getCenter(n) : n.copy(t);
		let r = 0;
	...
	expandByPoint(e) {
		...
		if (t > this.radius * this.radius) {
			...
			this.center.addScaledVector(gn, n / e), this.radius += n;
		}
		return this;
	}
	union(e) {
		return e.isEmpty() ? this : this.isEmpty() ? (this.copy(e), this) : (this.center.equals(e.center) === !0 ? this.radius = Math.max(this.radius, e.radius) : (_n.subVectors(e.center, this.center).setLength(e.radius), this.expandByPoint(gn.copy(e.center).add(_n)), this.expandByPoint(gn.copy(e.center).sub(_n))), this);
	}
	equals(e) {
...
}, yn = 0, bn = /*@__PURE__*/ new Ye(), xn = /*@__PURE__*/ new St(), Sn = /*@__PURE__*/ new W(), Cn = /*@__PURE__*/ new Kt(), wn = /*@__PURE__*/ new Kt(), Tn = /*@__PURE__*/ new W(), En = class e extends oe {
	constructor() {
		super(), this.isBufferGeometry = !0, Object.defineProperty(this, "id", { value: yn++ }), this.uuid = V(), this.name = "", this.type = "BufferGeometry", this.index = null, this.indirect = null, this.indirectOffset = 0, this.attributes = {}, this.morphAttributes = {}, this.morphTargetsRelative = !1, this.groups = [], this.boundingBox = null, this.boundingSphere = null, this.drawRange = {
			start: 0,
			count: Infinity
	...
	setIndex(e) {
		return Array.isArray(e) ? this.index = new (P(e) ? pn : fn)(e, 1) : this.index = e, this;
	}
	setIndirect(e, t = 0) {
	...
	computeBoundingBox() {
		...
		if (e !== void 0) {
			if (this.boundingBox.setFromBufferAttribute(e), t) for (let e = 0, n = t.length; e < n; e++) {
				let n = t[e];
				Cn.setFromBufferAttribute(n), this.morphTargetsRelative ? (Tn.addVectors(this.boundingBox.min, Cn.min), this.boundingBox.expandByPoint(Tn), Tn.addVectors(this.boundingBox.max, Cn.max), this.boundingBox.expandByPoint(Tn)) : (this.boundingBox.expandByPoint(Cn.min), this.boundingBox.expandByPoint(Cn.max));
			}
	...
	computeBoundingSphere() {
		...
		if (e) {
			...
			if (Cn.setFromBufferAttribute(e), t) for (let e = 0, n = t.length; e < n; e++) {
				let n = t[e];
				wn.setFromBufferAttribute(n), this.morphTargetsRelative ? (Tn.addVectors(Cn.min, wn.min), Cn.expandByPoint(Tn), Tn.addVectors(Cn.max, wn.max), Cn.expandByPoint(Tn)) : (Cn.expandByPoint(wn.min), Cn.expandByPoint(wn.max));
			}
			Cn.getCenter(n);
			let r = 0;
			for (let t = 0, i = e.count; t < i; t++) Tn.fromBufferAttribute(e, t), r = Math.max(r, n.distanceToSquared(Tn));
			if (t) for (let i = 0, a = t.length; i < a; i++) {
				let a = t[i], o = this.morphTargetsRelative;
				for (let t = 0, i = a.count; t < i; t++) Tn.fromBufferAttribute(a, t), o && (Sn.fromBufferAttribute(e, t), Tn.add(Sn)), r = Math.max(r, n.distanceToSquared(Tn));
			}
	...
	computeTangents() {
		...
		(a === void 0 || a.count !== n.count) && (a = new dn(new Float32Array(4 * n.count), 4), this.setAttribute("tangent", a));
		let o = [], s = [];
	...
	computeVertexNormals() {
		...
		if (t !== void 0) {
			...
			if (n === void 0 || n.count !== t.count) n = new dn(new Float32Array(t.count * 3), 3), this.setAttribute("normal", n);
	...
	normalizeNormals() {
		...
		for (let t = 0, n = e.count; t < n; t++) Tn.fromBufferAttribute(e, t), Tn.normalize(), e.setXYZ(t, Tn.x, Tn.y, Tn.z);
	}
	toNonIndexed() {
		function t(e, t) {
...
}, Dn = 0, On = class extends oe {
	constructor() {
		super(), this.isMaterial = !0, Object.defineProperty(this, "id", { value: Dn++ }), this.uuid = V(), this.name = "", this.type = "Material", this.blending = 1, this.side = 0, this.vertexColors = !1, this.opacity = 1, this.transparent = !1, this.alphaHash = !1, this.blendSrc = 204, this.blendDst = 205, this.blendEquation = 100, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new Z(0, 0, 0), this.blendAlpha = 0, this.depthFunc = 3, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = 519, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = M, this.stencilZFail = M, this.stencilZPass = M, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaToCoverage = !1, this.premultipliedAlpha = !1, this.forceSinglePass = !1, this.allowOverride = !0, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0, this._alphaTest = 0;
	}
	get alphaTest() {
...
}, kn = /*@__PURE__*/ new W(), An = /*@__PURE__*/ new W(), jn = /*@__PURE__*/ new W(), Mn = /*@__PURE__*/ new W(), Nn = /*@__PURE__*/ new W(), Pn = /*@__PURE__*/ new W(), Fn = /*@__PURE__*/ new W(), In = class {
	...
	distanceSqToPoint(e) {
		let t = kn.subVectors(e, this.origin).dot(this.direction);
	...
	distanceSqToSegment(e, t, n, r) {
		An.copy(e).add(t).multiplyScalar(.5), jn.copy(t).sub(e).normalize(), Mn.copy(this.origin).sub(An);
		let i = e.distanceTo(t) * .5, a = -this.direction.dot(jn), o = Mn.dot(this.direction), s = -Mn.dot(jn), c = Mn.lengthSq(), l = Math.abs(1 - a * a), u, d, f, p;
		...
		return n && n.copy(this.origin).addScaledVector(this.direction, u), r && r.copy(An).addScaledVector(jn, d), f;
	}
	intersectSphere(e, t) {
		kn.subVectors(e.center, this.origin);
		let n = kn.dot(this.direction), r = kn.dot(kn) - n * n, i = e.radius * e.radius;
		if (r > i) return null;
	...
	intersectTriangle(e, t, n, r, i) {
		Nn.subVectors(t, e), Pn.subVectors(n, e), Fn.crossVectors(Nn, Pn);
		let a = this.direction.dot(Fn), o;
		if (a > 0) {
			if (r) return null;
			o = 1;
		} else if (a < 0) o = -1, a = -a;
		...
		let s = o * this.direction.dot(Pn.crossVectors(Mn, Pn));
		if (s < 0) return null;
		let c = o * this.direction.dot(Nn.cross(Mn));
...
}, Rn = /*@__PURE__*/ new Ye(), zn = /*@__PURE__*/ new In(), Bn = /*@__PURE__*/ new vn(), Vn = /*@__PURE__*/ new W(), Hn = /*@__PURE__*/ new W(), Un = /*@__PURE__*/ new W(), Wn = /*@__PURE__*/ new W(), Gn = /*@__PURE__*/ new W(), Kn = /*@__PURE__*/ new W(), qn = /*@__PURE__*/ new W(), Jn = /*@__PURE__*/ new W(), Yn = class extends St {
	constructor(e = new En(), t = new Ln()) {
	...
	getVertexPosition(e, t) {
		...
		if (i && o) {
			...
			for (let n = 0, r = i.length; n < r; n++) {
				let r = o[n], s = i[n];
				r !== 0 && (Gn.fromBufferAttribute(s, e), a ? Kn.addScaledVector(Gn, r) : Kn.addScaledVector(Gn.sub(t), r));
			}
			t.add(Kn);
		}
		return t;
	...
	raycast(e, t) {
		...
		r !== void 0 && (n.boundingSphere === null && n.computeBoundingSphere(), Bn.copy(n.boundingSphere), Bn.applyMatrix4(i), zn.copy(e.ray).recast(e.near), !(Bn.containsPoint(zn.origin) === !1 && (zn.intersectSphere(Bn, Vn) === null || zn.origin.distanceToSquared(Vn) > (e.far - e.near) ** 2)) && (Rn.copy(i).invert(), zn.copy(e.ray).applyMatrix4(Rn), !(n.boundingBox !== null && zn.intersectsBox(n.boundingBox) === !1) && this._computeIntersections(e, t, zn)));
	}
	_computeIntersections(e, t, n) {
		...
		if (o !== null) if (Array.isArray(a)) for (let i = 0, s = d.length; i < s; i++) {
			...
			for (let i = m, a = h; i < a; i += 3) {
				...
				r = Zn(this, p, e, n, c, l, u, a, d, f), r && (r.faceIndex = Math.floor(i / 3), r.face.materialIndex = s.materialIndex, t.push(r));
			}
		}
		else {
			...
			for (let i = m, a = h; i < a; i += 3) {
				let a = i, s = i + 1, d = i + 2;
				r = Zn(this, p, e, n, c, l, u, a, s, d), r && (r.faceIndex = Math.floor(i / 3), r.face.materialIndex = o.materialIndex, t.push(r));
			}
		}
		else {
...
function Zn(e, t, n, r, i, a, o, s, c, l) {
	e.getVertexPosition(s, Hn), e.getVertexPosition(c, Un), e.getVertexPosition(l, Wn);
	let u = Xn(e, t, n, r, Hn, Un, Wn, qn);
	if (u) {
		let e = new W();
		Gt.getBarycoord(qn, Hn, Un, Wn, e), i && (u.uv = Gt.getInterpolatedAttribute(i, s, c, l, e, new U())), a && (u.uv1 = Gt.getInterpolatedAttribute(a, s, c, l, e, new U())), o && (u.normal = Gt.getInterpolatedAttribute(o, s, c, l, e, new W()), u.normal.dot(r.direction) > 0 && u.normal.multiplyScalar(-1));
		let t = {
			a: s,
			b: c,
			c: l,
		...
		Gt.getNormal(Hn, Un, Wn, t.normal), u.face = t, u.barycoord = e;
	}
	return u;
}
var Qn = class extends Ue {
...
}, $n = /*@__PURE__*/ new W(), er = /*@__PURE__*/ new W(), tr = /*@__PURE__*/ new K(), nr = class {
...
}, rr = /*@__PURE__*/ new vn(), ir = /*@__PURE__*/ new U(.5, .5), ar = /*@__PURE__*/ new W(), or = class {
	...
	intersectsSprite(e) {
		return rr.center.set(0, 0, 0), rr.radius = .7071067811865476 + ir.distanceTo(e.center), rr.applyMatrix4(e.matrixWorld), this.intersectsSphere(rr);
	}
	intersectsSphere(e) {
	...
	intersectsBox(e) {
		...
		for (let n = 0; n < 6; n++) {
			let r = t[n];
			if (ar.x = r.normal.x > 0 ? e.max.x : e.min.x, ar.y = r.normal.y > 0 ? e.max.y : e.min.y, ar.z = r.normal.z > 0 ? e.max.z : e.min.z, r.distanceToPoint(ar) < 0) return !1;
		}
		return !0;
	}
	containsPoint(e) {
	...
	copy(e) {
		return super.copy(e), this.source = new ze(Object.assign({}, e.image)), this.compareFunction = e.compareFunction, this;
	}
	toJSON(e) {
		let t = super.toJSON(e);
	...
	constructor(e = 1, t = 1, n = 1, r = 1, i = 1, a = 1) {
		...
		let s = [], c = [], l = [], u = [], d = 0, f = 0;
		p("z", "y", "x", -1, -1, n, t, e, a, i, 0), p("z", "y", "x", 1, -1, n, t, -e, a, i, 1), p("x", "z", "y", 1, 1, e, n, t, r, a, 2), p("x", "z", "y", 1, -1, e, n, -t, r, a, 3), p("x", "y", "z", 1, -1, e, t, n, r, i, 4), p("x", "y", "z", -1, -1, e, t, -n, r, i, 5), this.setIndex(s), this.setAttribute("position", new mn(c, 3)), this.setAttribute("normal", new mn(l, 3)), this.setAttribute("uv", new mn(u, 2));
	...
	computeFrenetFrames(e, t = !1) {
		let n = new W(), r = [], i = [], a = [], o = new W(), s = new Ye();
		for (let t = 0; t <= e; t++) {
			let n = t / e;
...
var _r = /*@__PURE__*/ new W(), vr = /*@__PURE__*/ new W(), yr = /*@__PURE__*/ new gr(), br = /*@__PURE__*/ new gr(), xr = /*@__PURE__*/ new gr(), Sr = class extends pr {
	...
	getPoint(e, t = new W()) {
		...
		if (this.closed || o + 2 < i ? l = r[(o + 2) % i] : (_r.subVectors(r[i - 1], r[i - 2]).add(r[i - 1]), l = _r), this.curveType === "centripetal" || this.curveType === "chordal") {
			let e = this.curveType === "chordal" ? .5 : .25, t = c.distanceToSquared(u) ** +e, n = u.distanceToSquared(d) ** +e, r = d.distanceToSquared(l) ** +e;
			n < 1e-4 && (n = 1), t < 1e-4 && (t = n), r < 1e-4 && (r = n), yr.initNonuniformCatmullRom(c.x, u.x, d.x, l.x, t, n, r), br.initNonuniformCatmullRom(c.y, u.y, d.y, l.y, t, n, r), xr.initNonuniformCatmullRom(c.z, u.z, d.z, l.z, t, n, r);
		} else this.curveType === "catmullrom" && (yr.initCatmullRom(c.x, u.x, d.x, l.x, this.tension), br.initCatmullRom(c.y, u.y, d.y, l.y, this.tension), xr.initCatmullRom(c.z, u.z, d.z, l.z, this.tension));
		return n.set(yr.calc(s), br.calc(s), xr.calc(s)), n;
	}
	copy(e) {
...
function Mr(e, t, n, r, i) {
	return Or(e, t) + kr(e, n) + Ar(e, r) + jr(e, i);
}
var Nr = class extends pr {
	...
	getPoint(e, t = new U()) {
		...
		return n.set(Mr(e, r.x, i.x, a.x, o.x), Mr(e, r.y, i.y, a.y, o.y)), n;
	}
	copy(e) {
	...
	getPoint(e, t = new W()) {
		let n = t, r = this.v0, i = this.v1, a = this.v2, o = this.v3;
		return n.set(Mr(e, r.x, i.x, a.x, o.x), Mr(e, r.y, i.y, a.y, o.y), Mr(e, r.z, i.z, a.z, o.z)), n;
	}
	copy(e) {
		return super.copy(e), this.v0.copy(e.v0), this.v1.copy(e.v1), this.v2.copy(e.v2), this.v3.copy(e.v3), this;
	}
	...
	getPoint(e, t = new U()) {
		...
		return n.set(Dr(e, r.x, i.x, a.x), Dr(e, r.y, i.y, a.y)), n;
	}
	copy(e) {
	...
	getPoint(e, t = new W()) {
		let n = t, r = this.v0, i = this.v1, a = this.v2;
		return n.set(Dr(e, r.x, i.x, a.x), Dr(e, r.y, i.y, a.y), Dr(e, r.z, i.z, a.z)), n;
	}
	copy(e) {
		return super.copy(e), this.v0.copy(e.v0), this.v1.copy(e.v1), this.v2.copy(e.v2), this;
	}
	...
	getPoint(e, t = new U()) {
		...
		return n.set(Cr(o, s.x, c.x, l.x, u.x), Cr(o, s.y, c.y, l.y, u.y)), n;
	}
	copy(e) {
		super.copy(e), this.points = [];
		for (let t = 0, n = e.points.length; t < n; t++) {
	...
	fromJSON(e) {
		...
		for (let t = 0, n = e.curves.length; t < n; t++) {
			let n = e.curves[t];
			this.curves.push(new Br[n.type]().fromJSON(n));
		}
		return this;
	}
}, Hr = class extends Vr {
	...
	lineTo(e, t) {
		let n = new Fr(this.currentPoint.clone(), new U(e, t));
		return this.curves.push(n), this.currentPoint.set(e, t), this;
	}
	quadraticCurveTo(e, t, n, r) {
		let i = new Lr(this.currentPoint.clone(), new U(e, t), new U(n, r));
		return this.curves.push(i), this.currentPoint.set(n, r), this;
	}
	bezierCurveTo(e, t, n, r, i, a) {
		let o = new Nr(this.currentPoint.clone(), new U(e, t), new U(n, r), new U(i, a));
	...
	constructor(e) {
		super(e), this.uuid = V(), this.type = "Shape", this.holes = [];
	}
	getPointsHoles(e) {
		let t = [];
...
function Wr(e, t, n = 2) {
	let r = t && t.length, i = r ? t[0] * n : e.length, a = Gr(e, 0, i, n, !0), o = [];
	if (!a || a.next === a.prev) return o;
	let s, c, l;
	if (r && (a = Qr(e, t, a, n)), e.length > 80 * n) {
		s = e[0], c = e[1];
		let t = s, r = c;
		for (let a = n; a < i; a += n) {
			let n = e[a], i = e[a + 1];
	...
	return qr(a, o, n, s, c, l, 0), o;
}
function Gr(e, t, n, r, i) {
	let a;
	if (i === Si(e, t, n, r) > 0) for (let i = t; i < n; i += r) a = yi(i / r | 0, e[i], e[i + 1], a);
	else for (let i = n - r; i >= t; i -= r) a = yi(i / r | 0, e[i], e[i + 1], a);
	return a && di(a, a.next) && (bi(a), a = a.next), a;
}
function Kr(e, t) {
	if (!e) return e;
	t ||= e;
	let n = e, r;
	do
		if (r = !1, !n.steiner && (di(n, n.next) || ui(n.prev, n, n.next) === 0)) {
			if (bi(n), n = t = n.prev, n === n.next) break;
			r = !0;
		} else n = n.next;
	while (r || n !== t);
	return t;
...
function qr(e, t, n, r, i, a, o) {
	...
	for (; e.prev !== e.next;) {
		...
		if (a ? Yr(e, r, i, a) : Jr(e)) {
			t.push(c.i, e.i, l.i), bi(e), e = l.next, s = l.next;
			continue;
		}
		if (e = l, e === s) {
			o ? o === 1 ? (e = Xr(Kr(e), t), qr(e, t, n, r, i, a, 2)) : o === 2 && Zr(e, t, n, r, i, a) : qr(Kr(e), t, n, r, i, a, 1);
			break;
		}
	}
}
...
function Yr(e, t, n, r) {
	...
	if (ui(i, a, o) >= 0) return !1;
	let s = i.x, c = a.x, l = o.x, u = i.y, d = a.y, f = o.y, p = Math.min(s, c, l), m = Math.min(u, d, f), h = Math.max(s, c, l), g = Math.max(u, d, f), _ = ai(p, m, t, n, r), v = ai(h, g, t, n, r), y = e.prevZ, b = e.nextZ;
	for (; y && y.z >= _ && b && b.z <= v;) {
		if (y.x >= p && y.x <= h && y.y >= m && y.y <= g && y !== i && y !== o && ci(s, u, c, d, l, f, y.x, y.y) && ui(y.prev, y, y.next) >= 0 || (y = y.prevZ, b.x >= p && b.x <= h && b.y >= m && b.y <= g && b !== i && b !== o && ci(s, u, c, d, l, f, b.x, b.y) && ui(b.prev, b, b.next) >= 0)) return !1;
		b = b.nextZ;
	}
	for (; y && y.z >= _;) {
		if (y.x >= p && y.x <= h && y.y >= m && y.y <= g && y !== i && y !== o && ci(s, u, c, d, l, f, y.x, y.y) && ui(y.prev, y, y.next) >= 0) return !1;
		y = y.prevZ;
	}
	for (; b && b.z <= v;) {
		if (b.x >= p && b.x <= h && b.y >= m && b.y <= g && b !== i && b !== o && ci(s, u, c, d, l, f, b.x, b.y) && ui(b.prev, b, b.next) >= 0) return !1;
		b = b.nextZ;
	}
	return !0;
}
function Xr(e, t) {
	...
	do {
		...
		!di(r, i) && fi(r, n, n.next, i) && gi(r, i) && gi(i, r) && (t.push(r.i, n.i, i.i), bi(n), bi(n.next), n = e = i), n = n.next;
	} while (n !== e);
	return Kr(n);
}
function Zr(e, t, n, r, i, a) {
	...
	do {
		...
		for (; e !== o.prev;) {
			if (o.i !== e.i && li(o, e)) {
				let s = vi(o, e);
				o = Kr(o, o.next), s = Kr(s, s.next), qr(o, t, n, r, i, a, 0), qr(s, t, n, r, i, a, 0);
				return;
			}
			e = e.next;
		}
...
function Qr(e, t, n, r) {
	...
	for (let n = 0, a = t.length; n < a; n++) {
		let o = Gr(e, t[n] * r, n < a - 1 ? t[n + 1] * r : e.length, r, !1);
		o === o.next && (o.steiner = !0), i.push(oi(o));
	}
	i.sort($r);
	for (let e = 0; e < i.length; e++) n = ei(i[e], n);
	return n;
}
function $r(e, t) {
	let n = e.x - t.x;
...
function ei(e, t) {
	...
	if (!n) return t;
	let r = vi(n, e);
	return Kr(r, r.next), Kr(n, n.next);
}
function ti(e, t) {
	let n = t, r = e.x, i = e.y, a = -Infinity, o;
	if (di(e, n)) return n;
	do {
		if (di(e, n.next)) return n.next;
	...
	n = o;
	do {
		if (r >= n.x && n.x >= c && r !== n.x && si(i < l ? r : a, i, c, l, i < l ? a : r, i, n.x, n.y)) {
			let t = Math.abs(i - n.y) / (r - n.x);
			gi(n, e) && (t < u || t === u && (n.x > o.x || n.x === o.x && ni(o, n))) && (o = n, u = t);
		}
		n = n.next;
	} while (n !== s);
	return o;
...
function ni(e, t) {
	return ui(e.prev, e, t.prev) < 0 && ui(t.next, e, e.next) < 0;
}
function ri(e, t, n, r) {
	let i = e;
	do
		i.z === 0 && (i.z = ai(i.x, i.y, t, n, r)), i.prevZ = i.prev, i.nextZ = i.next, i = i.next;
	while (i !== e);
	i.prevZ.nextZ = null, i.prevZ = null, ii(i);
}
function ii(e) {
	let t, n = 1;
	do {
...
function ci(e, t, n, r, i, a, o, s) {
	return !(e === o && t === s) && si(e, t, n, r, i, a, o, s);
}
function li(e, t) {
	return e.next.i !== t.i && e.prev.i !== t.i && !hi(e, t) && (gi(e, t) && gi(t, e) && _i(e, t) && (ui(e.prev, e, t.prev) || ui(e, t.prev, t)) || di(e, t) && ui(e.prev, e, e.next) > 0 && ui(t.prev, t, t.next) > 0);
}
function ui(e, t, n) {
...
function fi(e, t, n, r) {
	let i = mi(ui(e, t, n)), a = mi(ui(e, t, r)), o = mi(ui(n, r, e)), s = mi(ui(n, r, t));
...
function gi(e, t) {
	return ui(e.prev, e, e.next) < 0 ? ui(e, t, e.next) >= 0 && ui(e, e.prev, t) >= 0 : ui(e, t, e.prev) < 0 || ui(e, e.next, t) < 0;
}
function _i(e, t) {
...
function vi(e, t) {
	let n = xi(e.i, e.x, e.y), r = xi(t.i, t.x, t.y), i = e.next, a = t.prev;
...
var Ci = class {
	...
	static triangulateShape(e, t) {
		...
		let a = e.length;
		t.forEach(Ti);
		for (let e = 0; e < t.length; e++) r.push(a), a += t[e].length, Ei(n, t[e]);
		let o = Ci.triangulate(n, r);
...
var Di = class e extends En {
	constructor(e = new Ur([
		...
		this.setAttribute("position", new mn(r, 3)), this.setAttribute("uv", new mn(i, 2)), this.computeVertexNormals();
		function a(e) {
			let a = [], o = t.curveSegments === void 0 ? 12 : t.curveSegments, s = t.steps === void 0 ? 1 : t.steps, c = t.depth === void 0 ? 1 : t.depth, l = t.bevelEnabled === void 0 ? !0 : t.bevelEnabled, u = t.bevelThickness === void 0 ? .2 : t.bevelThickness, d = t.bevelSize === void 0 ? u - .1 : t.bevelSize, f = t.bevelOffset === void 0 ? 0 : t.bevelOffset, p = t.bevelSegments === void 0 ? 3 : t.bevelSegments, m = t.extrudePath, h = t.UVGenerator === void 0 ? Oi : t.UVGenerator, g, _ = !1, v, y, b, x;
			if (m) {
			...
			if (!wi.isClockWise(C)) {
				...
				for (let e = 0, t = w.length; e < t; e++) {
					let t = w[e];
					wi.isClockWise(t) && (w[e] = t.reverse());
				}
			}
			function T(e) {
				let t = e[0];
			...
			let F;
			if (p === 0) F = wi.triangulateShape(D, w);
			else {
				let e = [], t = [];
				for (let n = 0; n < p; n++) {
					...
					for (let e = 0, n = E; e < n; e++) {
						...
						for (let e = 0, t = n.length; e < t; e++) {
							let t = O(n[e], N[e], a);
							R(t.x, t.y, -i), r === 0 && o.push(t);
						}
						r === 0 && t.push(o);
					}
				}
				F = wi.triangulateShape(e, t);
			}
			let I = F.length, ee = d + f;
			for (let e = 0; e < k; e++) {
				let t = l ? O(C[e], P[e], ee) : C[e];
				_ ? (b.copy(v.normals[0]).multiplyScalar(t.x), y.copy(v.binormals[0]).multiplyScalar(t.y), x.copy(g[0]).add(b).add(y), R(x.x, x.y, x.z)) : R(t.x, t.y, 0);
			}
			for (let e = 1; e <= s; e++) for (let t = 0; t < k; t++) {
				let n = l ? O(C[t], P[t], ee) : C[t];
				_ ? (b.copy(v.normals[e]).multiplyScalar(n.x), y.copy(v.binormals[e]).multiplyScalar(n.y), x.copy(g[e]).add(b).add(y), R(x.x, x.y, x.z)) : R(n.x, n.y, c / s * e);
			}
			for (let e = p - 1; e >= 0; e--) {
				...
				for (let e = 0, t = w.length; e < t; e++) {
					...
					for (let e = 0, i = t.length; e < i; e++) {
						let i = O(t[e], N[e], r);
						_ ? R(i.x, i.y + g[s - 1].y, g[s - 1].x + n) : R(i.x, i.y, c + n);
					}
				}
			}
			te(), ne();
	...
	static fromJSON(t, n) {
		...
		return i !== void 0 && (t.options.extrudePath = new Br[i.type]().fromJSON(i)), new e(r, t.options);
	}
}, Oi = {
...
var Ai = class e extends En {
	constructor(e = 1, t = 1, n = 1, r = 1) {
		...
		this.setIndex(f), this.setAttribute("position", new mn(p, 3)), this.setAttribute("normal", new mn(m, 3)), this.setAttribute("uv", new mn(h, 2));
	}
	copy(e) {
		return super.copy(e), this.parameters = Object.assign({}, e.parameters), this;
	}
...
function ji(e) {
	...
	for (let n in e) {
		...
		for (let r in e[n]) {
			let i = e[n][r];
			if (Ni(i)) i.isRenderTargetTexture ? (R("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."), t[n][r] = null) : t[n][r] = i.clone();
			else if (Array.isArray(i)) if (Ni(i[0])) {
				let e = [];
...
var Ii = {
	...
	constructor(e) {
		super(), this.isShaderMaterial = !0, this.type = "ShaderMaterial", this.defines = {}, this.uniforms = {}, this.uniformsGroups = [], this.vertexShader = Li, this.fragmentShader = Ri, this.linewidth = 1, this.wireframe = !1, this.wireframeLinewidth = 1, this.fog = !1, this.lights = !1, this.clipping = !1, this.forceSinglePass = !0, this.extensions = {
			clipCullDistance: !1,
			multiDraw: !1
...
var Gi = class {
	...
	validate() {
		...
		if (r !== void 0 && F(r)) for (let t = 0, n = r.length; t !== n; ++t) {
			let n = r[t];
			if (isNaN(n)) {
...
Xi.prototype.ValueTypeName = "", Xi.prototype.TimeBufferType = Float32Array, Xi.prototype.ValueBufferType = Float32Array, Xi.prototype.DefaultInterpolation = S;
var Zi = class extends Xi {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
Zi.prototype.ValueTypeName = "bool", Zi.prototype.ValueBufferType = Array, Zi.prototype.DefaultInterpolation = x, Zi.prototype.InterpolantFactoryMethodLinear = void 0, Zi.prototype.InterpolantFactoryMethodSmooth = void 0;
...
var ea = class extends Gi {
	...
	interpolate_(e, t, n, r) {
		...
		for (let e = c + o; c !== e; c += 4) je.slerpFlat(i, 0, a, c - o, a, c, s);
		return i;
	}
}, ta = class extends Xi {
	constructor(e, t, n, r) {
...
na.prototype.ValueTypeName = "string", na.prototype.ValueBufferType = Array, na.prototype.DefaultInterpolation = x, na.prototype.InterpolantFactoryMethodLinear = void 0, na.prototype.InterpolantFactoryMethodSmooth = void 0;
...
var ia = {
	...
	files: {},
	add: function(e, t) {
		this.enabled !== !1 && (aa(e) || (this.files[e] = t));
	},
	get: function(e) {
		if (this.enabled !== !1 && !aa(e)) return this.files[e];
	},
	remove: function(e) {
		delete this.files[e];
	},
...
sa.DEFAULT_MATERIAL_NAME = "__DEFAULT";
var ca = {}, la = class extends Error {
	constructor(e, t) {
	...
	load(e, t, n, r) {
		...
		fetch(a).then((t) => {
			if (t.status === 200 || t.status === 0) {
				...
				let n = ca[e], r = t.body.getReader(), i = t.headers.get("X-File-Size") || t.headers.get("Content-Length"), a = i ? parseInt(i) : 0, o = a !== 0, s = 0, c = new ReadableStream({ start(e) {
					t();
					function t() {
			...
			} else throw new la(`fetch for "${t.url}" responded with ${t.status}: ${t.statusText}`, t);
		}).then((e) => {
			switch (s) {
...
}, fa = /*@__PURE__*/ new Ye(), pa = /*@__PURE__*/ new W(), ma = /*@__PURE__*/ new W(), ha = class {
	constructor(e) {
		this.camera = e, this.intensity = 1, this.bias = 0, this.biasNode = null, this.normalBias = 0, this.radius = 1, this.blurSamples = 8, this.mapSize = new U(512, 512), this.mapType = o, this.map = null, this.mapPass = null, this.matrix = new Ye(), this.autoUpdate = !0, this.needsUpdate = !1, this._frustum = new or(), this._frameExtents = new U(1, 1), this._viewportCount = 1, this._viewports = [new We(0, 0, 1, 1)];
	}
	getViewportCount() {
	...
	updateMatrices(e) {
		...
		pa.setFromMatrixPosition(e.matrixWorld), t.position.copy(pa), ma.setFromMatrixPosition(e.target.matrixWorld), t.lookAt(ma), t.updateMatrixWorld(), fa.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), this._frustum.setFromProjectionMatrix(fa, t.coordinateSystem, t.reversedDepth), t.coordinateSystem === 2001 || t.reversedDepth ? n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, 1, 0, 0, 0, 0, 1) : n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, .5, .5, 0, 0, 0, 1), n.multiply(fa);
	}
	getViewport(e) {
...
}, ga = /*@__PURE__*/ new W(), _a = /*@__PURE__*/ new je(), va = /*@__PURE__*/ new W(), ya = class extends St {
	constructor() {
		super(), this.isCamera = !0, this.type = "Camera", this.matrixWorldInverse = new Ye(), this.projectionMatrix = new Ye(), this.projectionMatrixInverse = new Ye(), this.coordinateSystem = N, this._reversedDepth = !1;
	}
	get reversedDepth() {
	...
	updateMatrixWorld(e) {
		super.updateMatrixWorld(e), this.matrixWorld.decompose(ga, _a, va), va.x === 1 && va.y === 1 && va.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(ga, _a, va.set(1, 1, 1)).invert();
	}
	updateWorldMatrix(e, t, n = !1) {
		super.updateWorldMatrix(e, t, n), this.matrixWorld.decompose(ga, _a, va), va.x === 1 && va.y === 1 && va.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(ga, _a, va.set(1, 1, 1)).invert();
	}
	clone() {
		return new this.constructor().copy(this);
	}
}, ba = /*@__PURE__*/ new W(), xa = /*@__PURE__*/ new U(), Sa = /*@__PURE__*/ new U(), Ca = class extends ya {
	...
	getViewSize(e, t) {
		return this.getViewBounds(e, xa, Sa), t.subVectors(Sa, xa);
	}
	...
	constructor(e, t) {
		super(e, t), this.isDirectionalLight = !0, this.type = "DirectionalLight", this.position.copy(St.DEFAULT_UP), this.updateMatrix(), this.target = new St(), this.shadow = new Ta();
	}
	dispose() {
...
}, Oa = -90, ka = 1, Aa = class extends St {
	constructor(e, t, n) {
		super(), this.type = "CubeCamera", this.renderTarget = n, this.coordinateSystem = null, this.activeMipmapLevel = 0;
		let r = new Ca(Oa, ka, e, t);
		r.layers = this.layers, this.add(r);
		let i = new Ca(Oa, ka, e, t);
		i.layers = this.layers, this.add(i);
		let a = new Ca(Oa, ka, e, t);
		a.layers = this.layers, this.add(a);
		let o = new Ca(Oa, ka, e, t);
		o.layers = this.layers, this.add(o);
		let s = new Ca(Oa, ka, e, t);
		s.layers = this.layers, this.add(s);
		let c = new Ca(Oa, ka, e, t);
...
}, Ma = "\\[\\]\\.:\\/", Na = /* @__PURE__ */ RegExp("[\\[\\]\\.:\\/]", "g"), Pa = "[^\\[\\]\\.:\\/]", Fa = "[^" + Ma.replace("\\.", "") + "]", Ia = /*@__PURE__*/ "((?:WC+[\\/:])*)".replace("WC", Pa), La = /*@__PURE__*/ "(WCOD+)?".replace("WCOD", Fa), Ra = /*@__PURE__*/ "(?:\\.(WC+)(?:\\[(.+)\\])?)?".replace("WC", Pa), za = /*@__PURE__*/ "\\.(WC+)(?:\\[(.+)\\])?".replace("WC", Pa), Ba = RegExp("^" + Ia + La + Ra + za + "$"), Va = [
	"material",
	"materials",
	"bones",
	"map"
	...
	static parseTrackName(e) {
		...
		if (r !== void 0 && r !== -1) {
			...
			Va.indexOf(e) !== -1 && (n.nodeName = n.nodeName.substring(0, r), n.objectName = e);
		}
...
Ua.Composite = Ha, Ua.prototype.BindingType = {
	Direct: 0,
	EntireArray: 1,
	ArrayElement: 2,
	HasFromToArray: 3
}, Ua.prototype.Versioning = {
	None: 0,
	NeedsUpdate: 1,
	MatrixWorldNeedsUpdate: 2
}, Ua.prototype.GetterByBindingType = [
	Ua.prototype._getValue_direct,
	Ua.prototype._getValue_array,
	Ua.prototype._getValue_arrayElement,
	Ua.prototype._getValue_toArray
], Ua.prototype.SetterByBindingTypeAndVersioning = [
	[
		Ua.prototype._setValue_direct,
		Ua.prototype._setValue_direct_setNeedsUpdate,
		Ua.prototype._setValue_direct_setMatrixWorldNeedsUpdate
	],
	[
		Ua.prototype._setValue_array,
		Ua.prototype._setValue_array_setNeedsUpdate,
		Ua.prototype._setValue_array_setMatrixWorldNeedsUpdate
	],
	[
		Ua.prototype._setValue_arrayElement,
		Ua.prototype._setValue_arrayElement_setNeedsUpdate,
		Ua.prototype._setValue_arrayElement_setMatrixWorldNeedsUpdate
	],
	[
		Ua.prototype._setValue_fromArray,
		Ua.prototype._setValue_fromArray_setNeedsUpdate,
		Ua.prototype._setValue_fromArray_setMatrixWorldNeedsUpdate
	]
], class e {
	static {
...
var Wa = /*@__PURE__*/ new U(), Ga = class {
	...
	setFromCenterAndSize(e, t) {
		let n = Wa.copy(t).multiplyScalar(.5);
		return this.min.copy(e).sub(n), this.max.copy(e).add(n), this;
	}
	clone() {
		return new this.constructor().copy(this);
	...
	distanceToPoint(e) {
		return this.clampPoint(e, Wa).distanceTo(e);
	}
	intersect(e) {
		return this.min.max(e.min), this.max.min(e.max), this.isEmpty() && this.makeEmpty(), this;
	}
	...
	constructor() {
		this.type = "ShapePath", this.color = new Z(), this.subPaths = [], this.currentPath = null, this.userData = {};
	}
	moveTo(e, t) {
		return this.currentPath = new Hr(), this.subPaths.push(this.currentPath), this.currentPath.moveTo(e, t), this;
	}
	lineTo(e, t) {
	...
	toShapes() {
		...
		n !== "nonzero" && n !== "evenodd" && (R("Fill-rule \"" + n + "\" is not supported, falling back to \"nonzero\"."), n = "nonzero");
...
var Q = {
	...
	points: {
		uniforms: /*@__PURE__*/ Mi([$.points, $.fog]),
	...
	depth: {
		uniforms: /*@__PURE__*/ Mi([$.common, $.displacementmap]),
	...
	sprite: {
		uniforms: /*@__PURE__*/ Mi([$.sprite, $.fog]),
...
Za.physical = {
	uniforms: /*@__PURE__*/ Mi([Za.standard.uniforms, {
		clearcoat: { value: 0 },
...
var Qa = {
	...
	b: 0,
	g: 0
}, $a = /*@__PURE__*/ new Ye(), eo = /*@__PURE__*/ new K();
...
function to(e, t, n, r, i, a) {
	...
	function h(t, n) {
		let i = p(n);
		i && (i.isCubeTexture || i.mapping === 306) ? (l === void 0 && (l = new Yn(new fr(1, 1, 1), new zi({
			name: "BackgroundCubeMaterial",
			uniforms: ji(Za.backgroundCube.uniforms),
			vertexShader: Za.backgroundCube.vertexShader,
			fragmentShader: Za.backgroundCube.fragmentShader,
			side: 1,
			depthTest: !1,
			depthWrite: !1,
			fog: !1,
		...
		} }), r.update(l)), l.material.uniforms.envMap.value = i, l.material.uniforms.backgroundBlurriness.value = n.backgroundBlurriness, l.material.uniforms.backgroundIntensity.value = n.backgroundIntensity, l.material.uniforms.backgroundRotation.value.setFromMatrix4($a.makeRotationFromEuler(n.backgroundRotation)).transpose(), i.isCubeTexture && i.isRenderTargetTexture === !1 && l.material.uniforms.backgroundRotation.value.premultiply(eo), l.material.toneMapped = Y.getTransfer(i.colorSpace) !== j, (u !== i || d !== i.version || f !== e.toneMapping) && (l.material.needsUpdate = !0, u = i, d = i.version, f = e.toneMapping), l.layers.enableAll(), t.unshift(l, l.geometry, l.material, 0, 0, null)) : i && i.isTexture && (c === void 0 && (c = new Yn(new Ai(2, 2), new zi({
			name: "BackgroundMaterial",
			uniforms: ji(Za.background.uniforms),
	...
	function g(t, r) {
		t.getRGB(Qa, Fi(e)), n.buffers.color.setClear(Qa.r, Qa.g, Qa.b, r, a);
	}
	function _() {
...
function ao(e) {
	let t = this, n = null, r = 0, i = !1, a = !1, o = new nr(), s = new K(), c = {
		value: null,
		needsUpdate: !1
	};
...
var oo = 4, so = [
	...
	.526,
	.582
], co = 20, lo = 256, uo = /*@__PURE__*/ new wa(), fo = /*@__PURE__*/ new Z(), po = null, mo = 0, ho = 0, go = !1, _o = /*@__PURE__*/ new W(), vo = class {
	constructor(e) {
		this._renderer = e, this._pingPongRenderTarget = null, this._lodMax = 0, this._cubeSize = 0, this._sizeLods = [], this._sigmas = [], this._lodMeshes = [], this._backgroundBox = null, this._cubemapMaterial = null, this._equirectMaterial = null, this._blurMaterial = null, this._ggxMaterial = null;
	}
	fromScene(e, t = 0, n = .1, r = 100, i = {}) {
		let { size: a = 256, position: o = _o } = i;
		po = this._renderer.getRenderTarget(), mo = this._renderer.getActiveCubeFace(), ho = this._renderer.getActiveMipmapLevel(), go = this._renderer.xr.enabled, this._renderer.xr.enabled = !1, this._setSize(a);
	...
	_cleanup(e) {
		this._renderer.setRenderTarget(po, mo, ho), this._renderer.xr.enabled = go, e.scissorTest = !1, xo(e, 0, 0, e.width, e.height);
	}
	_fromTexture(e, t) {
		e.mapping === 301 || e.mapping === 302 ? this._setSize(e.image.length === 0 ? 16 : e.image[0].width || e.image[0].image.width) : this._setSize(e.image.width / 4), po = this._renderer.getRenderTarget(), mo = this._renderer.getActiveCubeFace(), ho = this._renderer.getActiveMipmapLevel(), go = this._renderer.xr.enabled, this._renderer.xr.enabled = !1;
	...
	_allocateTargets() {
		...
		if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
			...
			let { _lodMax: r } = this;
			({lodMeshes: this._lodMeshes, sizeLods: this._sizeLods, sigmas: this._sigmas} = yo(r)), this._blurMaterial = Co(r, e, t), this._ggxMaterial = So(r, e, t);
		}
		return r;
	}
	_compileMaterial(e) {
		let t = new Yn(new En(), e);
		this._renderer.compile(t, uo);
	}
	_sceneToCubeUV(e, t, n, r, i) {
		let a = new Ca(90, 1, t, n), o = [
			1,
			-1,
			1,
			1,
		...
		c.getClearColor(fo), c.toneMapping = 0, c.autoClear = !1, c.state.buffers.depth.getReversed() && (c.setRenderTarget(r), c.clearDepth(), c.setRenderTarget(null)), this._backgroundBox === null && (this._backgroundBox = new Yn(new fr(), new Ln({
		...
		m ? m.isColor && (f.color.copy(m), e.background = null, p = !0) : (f.color.copy(fo), p = !0);
		for (let t = 0; t < 6; t++) {
			let n = t % 3;
	...
	_textureToCubeUV(e, t) {
		...
		xo(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, uo);
	}
	_applyPMREM(e) {
	...
	_applyGGXFilter(e, t, n) {
		...
		o.material = a;
		let s = a.uniforms, c = n / (this._lodMeshes.length - 1), l = t / (this._lodMeshes.length - 1), u = Math.sqrt(c * c - l * l) * (0 + c * 1.25), { _lodMax: d } = this, f = this._sizeLods[n], p = 3 * f * (n > d - oo ? n - d + oo : 0), m = 4 * (this._cubeSize - f);
		s.envMap.value = e.texture, s.roughness.value = u, s.mipInt.value = d - t, xo(i, p, m, 3 * f, 2 * f), r.setRenderTarget(i), r.render(o, uo), s.envMap.value = i.texture, s.roughness.value = 0, s.mipInt.value = d - n, xo(e, p, m, 3 * f, 2 * f), r.setRenderTarget(e), r.render(o, uo);
	}
	_blur(e, t, n, r, i) {
	...
	_halfBlur(e, t, n, r, i, a, o) {
		...
		l.material = c;
		let u = c.uniforms, d = this._sizeLods[n] - 1, f = isFinite(i) ? Math.PI / (2 * d) : 2 * Math.PI / (2 * co - 1), p = i / f, m = isFinite(i) ? 1 + Math.floor(3 * p) : co;
		m > co && R(`sigmaRadians, ${i}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${co}`);
		let h = [], g = 0;
		for (let e = 0; e < co; ++e) {
		...
		xo(t, 3 * v * (r > _ - oo ? r - _ + oo : 0), 4 * (this._cubeSize - v), 3 * v, 2 * v), s.setRenderTarget(t), s.render(l, uo);
	}
};
function yo(e) {
	let t = [], n = [], r = [], i = e, a = e - oo + 1 + so.length;
	for (let o = 0; o < a; o++) {
		let a = 2 ** i;
		t.push(a);
		let s = 1 / a;
		o > e - oo ? s = so[o - e + oo - 1] : o === 0 && (s = 0), n.push(s);
		...
		let h = new En();
		h.setAttribute("position", new dn(f, 3)), h.setAttribute("uv", new dn(p, 2)), h.setAttribute("faceIndex", new dn(m, 1)), r.push(new Yn(h, null)), i > oo && i--;
	}
	return {
		lodMeshes: r,
		sizeLods: t,
...
function Co(e, t, n) {
	let r = new Float32Array(co), i = new W(0, 1, 0);
	return new zi({
...
var Do = class extends Ke {
	...
	fromEquirectangularTexture(e, t) {
		...
		let o = new Yn(r, a), s = t.minFilter;
		return t.minFilter === 1008 && (t.minFilter = i), new Aa(1, 10, this).update(e, o), t.minFilter = s, o.geometry.dispose(), o.material.dispose(), this;
	}
	clear(e, t = !0, n = !0, r = !0) {
...
function Ao(e, t, n, r) {
	...
	function l(e) {
		...
		let s = new (i.count >= 65535 ? pn : fn)(n, 1);
		s.version = o;
		let c = a.get(e);
	...
	function r(t, r, i) {
		switch (n.calls++, r) {
			...
			case e.POINTS:
				...
				break;
			default:
				z("WebGLInfo: Unknown draw mode:", r);
				break;
		}
	}
	function i() {
...
function No(e, t, n) {
	let r = /* @__PURE__ */ new WeakMap(), i = new We();
	function a(a, o, s) {
...
function Io(e, t, n, r, i, a) {
	let o = new Ke(t, n, {
		...
		stencilBuffer: a,
		samples: r ? 4 : 0,
		depthTexture: i ? new lr(t, n) : void 0
	}), s = new Ke(t, n, {
		type: u,
		depthBuffer: !1,
		stencilBuffer: !1
	}), c = new En();
	c.setAttribute("position", new mn([
		-1,
		3,
		0,
		-1,
	...
	let l = new Bi({
		...
		depthTest: !1,
		depthWrite: !1
	}), d = new Yn(c, l), f = new wa(-1, 1, 1, -1, 0, 1), p = null, m = null, h = !1, g, _ = null, v = [], y = !1;
	this.setSize = function(e, t) {
		...
		if (p !== e.outputColorSpace || m !== e.toneMapping) {
			p = e.outputColorSpace, m = e.toneMapping, l.defines = {}, Y.getTransfer(p) === "srgb" && (l.defines.SRGB_TRANSFER = "");
			let t = Fo[m];
...
var Lo = /*@__PURE__*/ new Ue(), Ro = /*@__PURE__*/ new lr(1, 1), zo = /*@__PURE__*/ new qe(), Bo = /*@__PURE__*/ new Je(), Vo = /*@__PURE__*/ new sr(), Ho = [], Uo = [], Wo = /* @__PURE__ */ new Float32Array(16), Go = /* @__PURE__ */ new Float32Array(9), Ko = /* @__PURE__ */ new Float32Array(4);
function qo(e, t, n) {
	let r = e[0];
	if (r <= 0 || r > 0) return e;
	let i = t * n, a = Ho[i];
...
function Ys(e) {
	Y._getMatrix(Js, Y.workingColorSpace, e);
...
var ec = /*@__PURE__*/ new W();
function tc() {
	return Y.getLuminanceCoefficients(ec), [
...
function Ac(e, t, n, r, i, a) {
	let o = new ot(), s = new Dc(), c = /* @__PURE__ */ new Set(), l = [], u = /* @__PURE__ */ new Map(), d = r.logarithmicDepthBuffer, f = r.precision, p = {
	...
	function h(i, o, l, u, h, g) {
		...
		let ke = {
			...
			packedNormalMap: z && i.normalMapType === 0 && kc(i.normalMap.format),
			metalnessMap: ae,
			roughnessMap: oe,
			anisotropy: B,
			anisotropyMap: ue,
			...
			vertexTangents: !!v.attributes.tangent && (z || B),
			...
			toneMapping: Oe,
			decodeVideoTexture: F && i.map.isVideoTexture === !0 && Y.getTransfer(i.map.colorSpace) === "srgb",
			decodeVideoTextureEmissive: ie && i.emissiveMap.isVideoTexture === !0 && Y.getTransfer(i.emissiveMap.colorSpace) === "srgb",
...
function Pc() {
	...
	function u(e, t, a) {
		n.length > 1 && n.sort(e || Mc), r.length > 1 && r.sort(t || Nc), i.length > 1 && i.sort(t || Nc), a && (n.reverse(), r.reverse(), i.reverse());
	}
	function d() {
...
var Uc = "void main() {\n	gl_Position = vec4( position, 1.0 );\n}", Wc = "uniform sampler2D shadow_pass;\nuniform vec2 resolution;\nuniform float radius;\nvoid main() {\n	const float samples = float( VSM_SAMPLES );\n	float mean = 0.0;\n	float squared_mean = 0.0;\n	float uvStride = samples <= 1.0 ? 0.0 : 2.0 / ( samples - 1.0 );\n	float uvStart = samples <= 1.0 ? 0.0 : - 1.0;\n	for ( float i = 0.0; i < samples; i ++ ) {\n		float uvOffset = uvStart + i * uvStride;\n		#ifdef HORIZONTAL_PASS\n			vec2 distribution = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( uvOffset, 0.0 ) * radius ) / resolution ).rg;\n			mean += distribution.x;\n			squared_mean += distribution.y * distribution.y + distribution.x * distribution.x;\n		#else\n			float depth = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( 0.0, uvOffset ) * radius ) / resolution ).r;\n			mean += depth;\n			squared_mean += depth * depth;\n		#endif\n	}\n	mean = mean / samples;\n	squared_mean = squared_mean / samples;\n	float std_dev = sqrt( max( 0.0, squared_mean - mean * mean ) );\n	gl_FragColor = vec4( mean, std_dev, 0.0, 1.0 );\n}", Gc = [
	...
	/*@__PURE__*/ new W(0, -1, 0),
	/*@__PURE__*/ new W(0, -1, 0)
], qc = /*@__PURE__*/ new Ye(), Jc = /*@__PURE__*/ new W(), Yc = /*@__PURE__*/ new W();
function Xc(e, t, n) {
	let a = new or(), o = new U(), s = new U(), d = new We(), f = new Hi(), p = new Ui(), m = {}, g = n.maxTextureSize, _ = {
		0: 1,
		1: 0,
		2: 2
	}, y = new zi({
	...
	let x = new En();
	x.setAttribute("position", new dn(new Float32Array([
		-1,
		-1,
		.5,
		3,
	...
	let S = new Yn(x, y), C = this;
	this.enabled = !1, this.autoUpdate = !0, this.needsUpdate = !1, this.type = 1;
	let w = this.type;
	this.render = function(t, n, f) {
		if (C.enabled === !1 || C.autoUpdate === !1 && C.needsUpdate === !1 || t.length === 0) return;
		this.type === 2 && (R("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."), this.type = 1);
		...
		for (let p = 0, m = t.length; p < m; p++) {
			...
			if (_.camera._reversedDepth = S, _.map === null || b === !0) {
				if (_.map !== null && (_.map.depthTexture !== null && (_.map.depthTexture.dispose(), _.map.depthTexture = null), _.map.dispose()), this.type === 3) {
					...
					_.map = new Ke(o.x, o.y, {
						format: v,
						type: u,
						minFilter: i,
						magFilter: i,
						generateMipmaps: !1
					}), _.map.texture.name = m.name + ".shadowMap", _.map.depthTexture = new lr(o.x, o.y, l), _.map.depthTexture.name = m.name + ".shadowMapDepth", _.map.depthTexture.format = h, _.map.depthTexture.compareFunction = null, _.map.depthTexture.minFilter = r, _.map.depthTexture.magFilter = r;
				} else m.isPointLight ? (_.map = new Do(o.x), _.map.depthTexture = new ur(o.x, c)) : (_.map = new Ke(o.x, o.y), _.map.depthTexture = new lr(o.x, o.y, c)), _.map.depthTexture.name = m.name + ".shadowMap", _.map.depthTexture.format = h, this.type === 1 ? (_.map.depthTexture.compareFunction = S ? 518 : 515, _.map.depthTexture.minFilter = i, _.map.depthTexture.magFilter = i) : (_.map.depthTexture.compareFunction = null, _.map.depthTexture.minFilter = r, _.map.depthTexture.magFilter = r);
	...
	function T(n, r) {
		let i = t.update(S);
		y.defines.VSM_SAMPLES !== n.blurSamples && (y.defines.VSM_SAMPLES = n.blurSamples, b.defines.VSM_SAMPLES = n.blurSamples, y.needsUpdate = !0, b.needsUpdate = !0), n.mapPass === null && (n.mapPass = new Ke(o.x, o.y, {
			format: v,
			type: u
...
function Zc(e, t) {
	function n() {
		let t = !1, n = new We(), r = null, i = new We(0, 0, 0, 0);
		return {
			setMask: function(n) {
	...
	function r() {
		...
		return {
			...
			setTest: function(t) {
				t ? oe(e.DEPTH_TEST) : B(e.DEPTH_TEST);
			},
			setMask: function(t) {
	...
	function i() {
		...
		return {
			setTest: function(n) {
				t || (n ? oe(e.STENCIL_TEST) : B(e.STENCIL_TEST));
			},
			setMask: function(r) {
	...
	let a = new n(), o = new r(), s = new i(), c = /* @__PURE__ */ new WeakMap(), l = /* @__PURE__ */ new WeakMap(), u = {}, d = {}, f = {}, p = /* @__PURE__ */ new WeakMap(), m = [], h = null, g = !1, _ = null, v = null, y = null, b = null, x = null, S = null, C = null, w = new Z(0, 0, 0), T = 0, E = !1, D = null, O = null, k = null, A = null, j = null, M = e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS), N = !1, P = 0, F = e.getParameter(e.VERSION);
	F.indexOf("WebGL") === -1 ? F.indexOf("OpenGL ES") !== -1 && (P = parseFloat(/^OpenGL ES (\d)/.exec(F)[1]), N = P >= 2) : (P = parseFloat(/^WebGL (\d)/.exec(F)[1]), N = P >= 1);
	let I = null, ee = {}, te = e.getParameter(e.SCISSOR_BOX), ne = e.getParameter(e.VIEWPORT), L = new We().fromArray(te), R = new We().fromArray(ne);
	function re(t, n, r, i) {
	...
	function ue(t, n, r, i, a, o, s, c, l, u) {
			...
			if (t !== _ || u !== E) {
				if ((v !== 100 || x !== 100) && (e.blendEquation(e.FUNC_ADD), v = 100, x = 100), u) switch (t) {
					...
					case 4:
						...
						break;
					default:
						z("WebGLState: Invalid blending: ", t);
						break;
				}
				else switch (t) {
					case 1:
		...
		a ||= n, o ||= r, s ||= i, (n !== v || a !== x) && (e.blendEquationSeparate(V[n], V[a]), v = n, x = a), (r !== y || i !== b || o !== S || s !== C) && (e.blendFuncSeparate(H[r], H[i], H[o], H[s]), y = r, b = i, S = o, C = s), (c.equals(w) === !1 || l !== T) && (e.blendColor(c.r, c.g, c.b, l), w.copy(c), T = l), _ = t, E = !1;
	}
	function de(t, n) {
		t.side === 2 ? B(e.CULL_FACE) : oe(e.CULL_FACE);
		let r = t.side === 1;
		...
		s.setTest(i), i && (s.setMask(t.stencilWriteMask), s.setFunc(t.stencilFunc, t.stencilRef, t.stencilFuncMask), s.setOp(t.stencilFail, t.stencilZFail, t.stencilZPass)), he(t.polygonOffset, t.polygonOffsetFactor, t.polygonOffsetUnits), t.alphaToCoverage === !0 ? oe(e.SAMPLE_ALPHA_TO_COVERAGE) : B(e.SAMPLE_ALPHA_TO_COVERAGE);
	}
	function fe(t) {
		D !== t && (t ? e.frontFace(e.CW) : e.frontFace(e.CCW), D = t);
	}
	function pe(t) {
		t === 0 ? B(e.CULL_FACE) : (oe(e.CULL_FACE), t !== O && (t === 1 ? e.cullFace(e.BACK) : t === 2 ? e.cullFace(e.FRONT) : e.cullFace(e.FRONT_AND_BACK))), O = t;
	}
	function me(t) {
		t !== k && (N && e.lineWidth(t), k = t);
	}
	function he(t, n, r) {
		t ? (oe(e.POLYGON_OFFSET_FILL), (A !== n || j !== r) && (A = n, j = r, o.getReversed() && (n = -n), e.polygonOffset(n, r))) : B(e.POLYGON_OFFSET_FILL);
	}
	function ge(t) {
		t ? oe(e.SCISSOR_TEST) : B(e.SCISSOR_TEST);
	}
	function _e(t) {
	...
	function ve(t, n, r) {
		...
		i === void 0 && (i = {
			type: void 0,
			texture: void 0
		}, ee[r] = i), (i.type !== t || i.texture !== n) && (I !== r && (e.activeTexture(r), I = r), e.bindTexture(t, n || ie[t]), i.type = t, i.texture = n);
	}
	function ye() {
		let t = ee[I];
	...
	function K() {
		e.disable(e.BLEND), e.disable(e.CULL_FACE), e.disable(e.DEPTH_TEST), e.disable(e.POLYGON_OFFSET_FILL), e.disable(e.SCISSOR_TEST), e.disable(e.STENCIL_TEST), e.disable(e.SAMPLE_ALPHA_TO_COVERAGE), e.blendEquation(e.FUNC_ADD), e.blendFunc(e.ONE, e.ZERO), e.blendFuncSeparate(e.ONE, e.ZERO, e.ONE, e.ZERO), e.blendColor(0, 0, 0, 0), e.colorMask(!0, !0, !0, !0), e.clearColor(0, 0, 0, 0), e.depthMask(!0), e.depthFunc(e.LESS), o.setReversed(!1), e.clearDepth(1), e.stencilMask(4294967295), e.stencilFunc(e.ALWAYS, 0, 4294967295), e.stencilOp(e.KEEP, e.KEEP, e.KEEP), e.clearStencil(0), e.cullFace(e.BACK), e.frontFace(e.CCW), e.polygonOffset(0, 0), e.activeTexture(e.TEXTURE0), e.bindFramebuffer(e.FRAMEBUFFER, null), e.bindFramebuffer(e.DRAW_FRAMEBUFFER, null), e.bindFramebuffer(e.READ_FRAMEBUFFER, null), e.useProgram(null), e.lineWidth(1), e.scissor(0, 0, e.canvas.width, e.canvas.height), e.viewport(0, 0, e.canvas.width, e.canvas.height), e.pixelStorei(e.PACK_ALIGNMENT, 4), e.pixelStorei(e.UNPACK_ALIGNMENT, 4), e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL, !1), e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL, !1), e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL, e.BROWSER_DEFAULT_WEBGL), e.pixelStorei(e.PACK_ROW_LENGTH, 0), e.pixelStorei(e.PACK_SKIP_PIXELS, 0), e.pixelStorei(e.PACK_SKIP_ROWS, 0), e.pixelStorei(e.UNPACK_ROW_LENGTH, 0), e.pixelStorei(e.UNPACK_IMAGE_HEIGHT, 0), e.pixelStorei(e.UNPACK_SKIP_PIXELS, 0), e.pixelStorei(e.UNPACK_SKIP_ROWS, 0), e.pixelStorei(e.UNPACK_SKIP_IMAGES, 0), u = {}, d = {}, I = null, ee = {}, f = {}, p = /* @__PURE__ */ new WeakMap(), m = [], h = null, g = !1, _ = null, v = null, y = null, b = null, x = null, S = null, C = null, w = new Z(0, 0, 0), T = 0, E = !1, D = null, O = null, k = null, A = null, j = null, L.set(0, 0, e.canvas.width, e.canvas.height), R.set(0, 0, e.canvas.width, e.canvas.height), a.reset(), o.reset(), s.reset();
	}
	return {
		buffers: {
			color: a,
...
function Qc(o, s, c, l, u, d, f) {
	...
	function C(e, t, n) {
		...
		} else return "data" in e && R("WebGLRenderer: Image in DataTexture is too big (" + i.width + "x" + i.height + ")."), e;
		return e;
	}
	function w(e) {
	...
	function re() {
		let e = ee;
		return e >= u.maxTextures && R("WebGLTextures: Trying to use " + e + " texture units while this GPU supports only " + u.maxTextures), ee += 1, e;
	}
	function ie(e) {
		let t = [];
	...
	function H(e, t) {
		if (t.type === 1015 && s.has("OES_texture_float_linear") === !1 && (t.magFilter === 1006 || t.magFilter === 1007 || t.magFilter === 1005 || t.magFilter === 1008 || t.minFilter === 1006 || t.minFilter === 1007 || t.minFilter === 1005 || t.minFilter === 1008) && R("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."), o.texParameteri(e, o.TEXTURE_WRAP_S, ce[t.wrapS]), o.texParameteri(e, o.TEXTURE_WRAP_T, ce[t.wrapT]), (e === o.TEXTURE_3D || e === o.TEXTURE_2D_ARRAY) && o.texParameteri(e, o.TEXTURE_WRAP_R, ce[t.wrapR]), o.texParameteri(e, o.TEXTURE_MAG_FILTER, le[t.magFilter]), o.texParameteri(e, o.TEXTURE_MIN_FILTER, le[t.minFilter]), t.compareFunction && (o.texParameteri(e, o.TEXTURE_COMPARE_MODE, o.COMPARE_REF_TO_TEXTURE), o.texParameteri(e, o.TEXTURE_COMPARE_FUNC, V[t.compareFunction])), s.has("EXT_texture_filter_anisotropic") === !0) {
	...
	function pe(e, t, n) {
		...
		if (a.version !== s.__version || i === !0) {
			if (c.activeTexture(o.TEXTURE0 + n), !(typeof ImageBitmap < "u" && t.image instanceof ImageBitmap)) {
				let e = Y.getPrimaries(Y.workingColorSpace), n = t.colorSpace === "" ? null : Y.getPrimaries(t.colorSpace), r = t.colorSpace === "" || e === n ? o.NONE : o.BROWSER_DEFAULT_WEBGL;
			...
			if (t.isDepthTexture) p = O(t.format === g, t.type), y && (_ ? c.texStorage2D(o.TEXTURE_2D, 1, p, e.width, e.height) : c.texImage2D(o.TEXTURE_2D, 0, p, e.width, e.height, 0, l, f, null));
				...
				for (let n = 0, r = h.length; n < r; n++) if (m = h[n], t.format !== 1023) if (l !== null) if (_) {
					if (b) if (t.layerUpdates.size > 0) {
						let e = qa(m.width, m.height, t.format, t.type);
				...
				if (y && c.texStorage3D(o.TEXTURE_2D_ARRAY, x, p, e.width, e.height, e.depth), b) if (t.layerUpdates.size > 0) {
					let n = qa(e.width, e.height, t.format, t.type);
					for (let r of t.layerUpdates) {
	...
	function me(e, t, n) {
		...
		if (i.version !== a.__version || r === !0) {
			...
			let e = Y.getPrimaries(Y.workingColorSpace), s = t.colorSpace === "" ? null : Y.getPrimaries(t.colorSpace), l = t.colorSpace === "" || e === s ? o.NONE : o.BROWSER_DEFAULT_WEBGL;
	...
	function _e(e, t, n) {
		...
		if (i.__renderTarget = t, (!i.__webglTexture || t.depthTexture.image.width !== t.width || t.depthTexture.image.height !== t.height) && (t.depthTexture.image.width = t.width, t.depthTexture.image.height = t.height, t.depthTexture.needsUpdate = !0), r) {
			if (i.__webglInit === void 0 && (i.__webglInit = !0, t.depthTexture.addEventListener("dispose", j)), i.__webglTexture === void 0) {
				i.__webglTexture = o.createTexture(), c.bindTexture(o.TEXTURE_CUBE_MAP, i.__webglTexture), H(o.TEXTURE_CUBE_MAP, t.depthTexture);
	...
	function be(e) {
		...
		if (a) {
			c.bindTexture(o.TEXTURE_CUBE_MAP, r.__webglTexture), H(o.TEXTURE_CUBE_MAP, t);
			...
			for (let t = 0, r = i.length; t < r; t++) {
				...
				(e.isWebGL3DRenderTarget || e.isWebGLArrayRenderTarget) && (s = e.isWebGL3DRenderTarget ? o.TEXTURE_3D : o.TEXTURE_2D_ARRAY), c.bindTexture(s, a.__webglTexture), H(s, r), he(n.__webglFramebuffer, e, r, o.COLOR_ATTACHMENT0 + t, s, 0), w(r) && T(s);
			}
			c.unbindTexture();
		} else {
			let i = o.TEXTURE_2D;
			if ((e.isWebGL3DRenderTarget || e.isWebGLArrayRenderTarget) && (i = e.isWebGL3DRenderTarget ? o.TEXTURE_3D : o.TEXTURE_2D_ARRAY), c.bindTexture(i, r.__webglTexture), H(i, t), t.mipmaps && t.mipmaps.length > 0) for (let r = 0; r < t.mipmaps.length; r++) he(n.__webglFramebuffer[r], e, t, o.COLOR_ATTACHMENT0, i, r);
	...
	function Oe(e, t) {
		...
		return e.isCompressedTexture === !0 || e.isVideoTexture === !0 || n !== "srgb-linear" && n !== "" && (Y.getTransfer(n) === "srgb" ? (r !== 1023 || i !== 1009) && R("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.") : z("WebGLTextures: Unsupported texture color space:", n)), t;
	}
	function ke(e) {
...
var el = "\nvoid main() {\n\n	gl_Position = vec4( position, 1.0 );\n\n}", tl = "\nuniform sampler2DArray depthColor;\nuniform float depthWidth;\nuniform float depthHeight;\n\nvoid main() {\n\n	vec2 coord = vec2( gl_FragCoord.x / depthWidth, gl_FragCoord.y / depthHeight );\n\n	if ( coord.x >= 1.0 ) {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x - 1.0, coord.y, 1 ) ).r;\n\n	} else {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;\n\n	}\n\n}", nl = class {
	...
	getMesh(e) {
		if (this.texture !== null && this.mesh === null) {
			let t = e.cameras[0].viewport, n = new zi({
				vertexShader: el,
				fragmentShader: tl,
				uniforms: {
			...
			this.mesh = new Yn(new Ai(20, 20), n);
		}
		return this.mesh;
	}
	reset() {
	...
	constructor(e, t) {
		super();
		let n = this, r = null, i = 1, a = null, s = "local-floor", l = 1, u = null, d = null, f = null, _ = null, v = null, y = null, b = typeof XRWebGLBinding < "u", x = new nl(), S = {}, C = t.getContextAttributes(), w = null, T = null, E = [], D = [], O = new U(), k = null, A = new Ca();
		A.viewport = new We();
		let j = new Ca();
		j.viewport = new We();
		let M = [A, j], N = new ja(), P = null, F = null;
		this.cameraAutoUpdate = !0, this.enabled = !1, this.isPresenting = !1, this.getController = function(e) {
			let t = E[e];
			return t === void 0 && (t = new Tt(), E[e] = t), t.getTargetRaySpace();
		}, this.getControllerGrip = function(e) {
			let t = E[e];
			return t === void 0 && (t = new Tt(), E[e] = t), t.getGripSpace();
		}, this.getHand = function(e) {
			let t = E[e];
			return t === void 0 && (t = new Tt(), E[e] = t), t.getHandSpace();
		};
		function I(e) {
		...
		function ee() {
			...
			e.setRenderTarget(w), v = null, _ = null, f = null, r = null, T = null, B.stop(), n.isPresenting = !1, e.setPixelRatio(k), e.setSize(O.width, O.height, !1), n.dispatchEvent({ type: "sessionend" });
		}
		this.setFramebufferScaleFactor = function(e) {
			...
			if (r = d, r !== null) {
				if (w = e.getRenderTarget(), r.addEventListener("select", I), r.addEventListener("selectstart", I), r.addEventListener("selectend", I), r.addEventListener("squeeze", I), r.addEventListener("squeezestart", I), r.addEventListener("squeezeend", I), r.addEventListener("end", ee), r.addEventListener("inputsourceschange", te), C.xrCompatible !== !0 && await t.makeXRCompatible(), k = e.getPixelRatio(), e.getSize(O), b && "createProjectionLayer" in XRWebGLBinding.prototype) {
					...
					f = this.getBinding(), _ = f.createProjectionLayer(l), r.updateRenderState({ layers: [_] }), e.setPixelRatio(1), e.setSize(_.textureWidth, _.textureHeight, !1), T = new Ke(_.textureWidth, _.textureHeight, {
						format: m,
						type: o,
						depthTexture: new lr(_.textureWidth, _.textureHeight, a, void 0, void 0, void 0, void 0, void 0, void 0, n),
					...
					v = new XRWebGLLayer(r, t, n), r.updateRenderState({ baseLayer: v }), e.setPixelRatio(1), e.setSize(v.framebufferWidth, v.framebufferHeight, !1), T = new Ke(v.framebufferWidth, v.framebufferHeight, {
						format: m,
						type: o,
						colorSpace: e.outputColorSpace,
						stencilBuffer: C.stencil,
				...
				T.isXRRenderTarget = !0, this.setFoveation(l), u = null, a = await r.requestReferenceSpace(s), B.setContext(r), B.start(), n.isPresenting = !0, n.dispatchEvent({ type: "sessionstart" });
			}
		...
		let ne = new W(), L = new W();
		function z(e, t, n) {
			ne.setFromMatrixPosition(t.matrixWorld), L.setFromMatrixPosition(n.matrixWorld);
			let r = ne.distanceTo(L), i = t.projectionMatrix.elements, a = n.projectionMatrix.elements, o = i[14] / (i[10] - 1), s = i[14] / (i[10] + 1), c = (i[9] + 1) / i[5], l = (i[9] - 1) / i[5], u = (i[8] - 1) / i[0], d = (a[8] + 1) / a[0], f = o * u, p = o * d, m = r / (-u + d), h = m * -u;
		...
		this.updateCamera = function(e) {
			...
			x.texture !== null && (x.depthNear > 0 && (t = x.depthNear), x.depthFar > 0 && (n = x.depthFar)), N.near = j.near = A.near = t, N.far = j.far = A.far = n, (P !== N.near || F !== N.far) && (r.updateRenderState({
				depthNear: N.near,
				depthFar: N.far
			...
			a.length === 2 ? z(N, A, j) : N.projectionMatrix.copy(A.projectionMatrix), ie(e, N, i);
		};
		function ie(e, t, n) {
		...
		let B = new Ya();
		B.setAnimationLoop(oe), this.setAnimationLoop = function(e) {
			ae = e;
		}, this.dispose = function() {};
	}
}, il = /*@__PURE__*/ new Ye(), al = /*@__PURE__*/ new K();
...
function ul() {
	return ll === null && (ll = new Qn(cl, 16, 16, v, u), ll.name = "DFG_LUT", ll.minFilter = i, ll.magFilter = i, ll.wrapS = t, ll.wrapT = t, ll.generateMipmaps = !1, ll.needsUpdate = !0), ll;
}
var dl = class {
	constructor(e = {}) {
		let { canvas: t = ee(), context: n = null, depth: r = !0, stencil: i = !1, alpha: l = !1, antialias: m = !1, premultipliedAlpha: h = !0, preserveDrawingBuffer: g = !1, powerPreference: v = "default", failIfMajorPerformanceCaveat: x = !1, reversedDepthBuffer: S = !1, outputBufferType: C = o } = e;
		...
		let T = C, E = /* @__PURE__ */ new Set([
			...
			d,
			f
		]), k = /* @__PURE__ */ new Uint32Array(4), A = /* @__PURE__ */ new Int32Array(4), j = new W(), M = null, P = null, F = [], I = [], te = null;
		this.domElement = t, this.debug = {
			checkShaderErrors: !0,
			onShaderError: null
		}, this.autoClear = !0, this.autoClearColor = !0, this.autoClearDepth = !0, this.autoClearStencil = !0, this.sortObjects = !0, this.clippingPlanes = [], this.localClippingEnabled = !1, this.toneMapping = 0, this.toneMappingExposure = 1, this.transmissionResolutionScale = 1;
		let L = this, re = !1, ae = null, oe = null, B = null, se = null;
		this._outputColorSpace = O;
		let ce = 0, le = 0, V = null, H = -1, ue = null, de = new We(), fe = new We(), pe = null, me = new Z(0), he = 0, ge = t.width, _e = t.height, ve = 1, ye = null, be = null, xe = new We(0, 0, ge, _e), Se = new We(0, 0, ge, _e), Ce = !1, we = new or(), Te = !1, Ee = !1, De = new Ye(), Oe = new W(), ke = new We(), Ae = {
			background: null,
			fog: null,
			environment: null,
		...
		try {
			...
			if ("setAttribute" in t && t.setAttribute("data-engine", "three.js r185"), t.addEventListener("webglcontextlost", rt, !1), t.addEventListener("webglcontextrestored", it, !1), t.addEventListener("webglcontextcreationerror", at, !1), G === null) {
				let t = "webgl2";
				if (G = Me(t, e), G === null) throw Me(t) ? Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.") : Error("THREE.WebGLRenderer: Error creating WebGL context.");
			}
		} catch (e) {
			throw z("WebGLRenderer: " + e.message), e;
		}
		let K, Ne, q, Pe, J, X, Fe, Ie, Le, Re, ze, Be, Ve, He, Ue, Ge, qe, Je, Xe, Ze, Qe, $e, et;
		function tt() {
			K = new ko(G), K.init(), Qe = new $c(G, K), Ne = new io(G, K, e, Qe), q = new Zc(G, K), Ne.reversedDepthBuffer && S && q.buffers.depth.setReversed(!0), oe = G.createFramebuffer(), B = G.createFramebuffer(), se = G.createFramebuffer(), Pe = new Mo(G), J = new jc(), X = new Qc(G, K, q, J, Ne, Qe, Pe), Fe = new Oo(L), Ie = new Xa(G), $e = new no(G, Ie), Le = new Ao(G, Ie, Pe, $e), Re = new Po(G, Le, Ie, $e, Pe), Je = new No(G, Ne, X), Ue = new ao(J), ze = new Ac(L, Fe, K, Ne, $e, Ue), Be = new ol(L, J), Ve = new Fc(), He = new Hc(K), qe = new to(L, Fe, q, Re, w, h), Ge = new Xc(L, Re, Ne), et = new sl(G, Pe, Ne, q), Xe = new ro(G, K, Pe), Ze = new jo(G, K, Pe), Pe.programs = ze.programs, L.capabilities = Ne, L.extensions = K, L.properties = J, L.renderLists = Ve, L.shadowMap = Ge, L.state = q, L.info = Pe;
		}
		tt(), T !== 1009 && (te = new Io(T, t.width, t.height, m, r, i));
		let nt = new rl(L, G);
		this.xr = nt, this.getContext = function() {
			...
			if (e) {
				let e = !1;
				if (V !== null) {
					let t = V.texture.format;
					e = E.has(t);
				}
				if (e) {
					let e = V.texture.type, t = D.has(e), n = qe.getClearColor(), r = qe.getClearAlpha(), i = n.r, a = n.g, o = n.b;
					t ? (k[0] = i, k[1] = a, k[2] = o, k[3] = r, G.clearBufferuiv(G.COLOR, 0, k)) : (A[0] = i, A[1] = a, A[2] = o, A[3] = r, G.clearBufferiv(G.COLOR, 0, A));
			...
			t.removeEventListener("webglcontextlost", rt, !1), t.removeEventListener("webglcontextrestored", it, !1), t.removeEventListener("webglcontextcreationerror", at, !1), qe.dispose(), Ve.dispose(), He.dispose(), J.dispose(), Fe.dispose(), Re.dispose(), $e.dispose(), et.dispose(), ze.dispose(), nt.dispose(), nt.removeEventListener("sessionstart", ft), nt.removeEventListener("sessionend", pt), mt.stop();
		};
		function rt(e) {
		...
		function it() {
			...
			let e = Pe.autoReset, t = Ge.enabled, n = Ge.autoUpdate, r = Ge.needsUpdate, i = Ge.type;
			tt(), Pe.autoReset = e, Ge.enabled = t, Ge.autoUpdate = n, Ge.needsUpdate = r, Ge.type = i;
		}
		function at(e) {
		...
		this.renderBufferDirect = function(e, t, n, r, i, a) {
			...
			$e.setup(i, r, s, n, c);
			let h, g = Xe;
			if (c !== null && (h = Ie.get(c), g = Ze, g.setIndex(h)), i.isMesh) r.wireframe === !0 ? (q.setLineWidth(r.wireframeLinewidth * je()), g.setMode(G.LINES)) : g.setMode(G.TRIANGLES);
			else if (i.isLine) {
				let e = r.linewidth;
				e === void 0 && (e = 1), q.setLineWidth(e * je()), i.isLineSegments ? g.setMode(G.LINES) : i.isLineLoop ? g.setMode(G.LINE_LOOP) : g.setMode(G.LINE_STRIP);
			} else i.isPoints ? g.setMode(G.POINTS) : i.isSprite && g.setMode(G.TRIANGLES);
			if (i.isBatchedMesh) if (K.get("WEBGL_multi_draw")) g.renderMultiDraw(i._multiDrawStarts, i._multiDrawCounts, i._multiDrawCount);
			else {
		...
		this.compile = function(e, t, n = null) {
			n === null && (n = e), P = He.get(n), P.init(t), I.push(P), n.traverseVisible(function(e) {
		...
		mt.setAnimationLoop(dt), typeof self < "u" && mt.setContext(self), this.setAnimationLoop = function(e) {
			...
			let n = nt.enabled === !0 && nt.isPresenting === !0, r = te !== null && (V === null || n) && te.begin(L, V);
			if (e.matrixWorldAutoUpdate === !0 && e.updateMatrixWorld(), t.parent === null && t.matrixWorldAutoUpdate === !0 && t.updateMatrixWorld(), nt.enabled === !0 && nt.isPresenting === !0 && (te === null || te.isCompositing() === !1) && (nt.cameraAutoUpdate === !0 && nt.updateCamera(t), t = nt.getCamera()), e.isScene === !0 && e.onBeforeRender(L, e, t, V), P = He.get(e, I.length), P.init(t), P.state.textureUnits = X.getTextureUnits(), I.push(P), De.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), we.setFromProjectionMatrix(De, N, t.reversedDepth), Ee = this.localClippingEnabled, Te = Ue.init(this.clippingPlanes, Ee), M = Ve.get(e, F.length), M.init(), F.push(M), nt.enabled === !0 && nt.isPresenting === !0) {
				let e = L.xr.getDepthSensingMesh();
				e !== null && ht(e, t, -Infinity, L.sortObjects);
			}
			ht(e, t, 0, L.sortObjects), M.finish(), L.sortObjects === !0 && M.sort(ye, be, t.reversedDepth), U = nt.enabled === !1 || nt.isPresenting === !1 || nt.hasDepthSensing() === !1, U && qe.addToRenderList(M, e), this.info.render.frame++, this.info.autoReset === !0 && this.info.reset(), Te === !0 && Ue.beginShadows();
			let i = P.state.shadowsArray;
			if (Ge.render(i, e, t), Te === !0 && Ue.endShadows(), (r && te.hasRenderPass()) === !1) {
				...
				} else r.length > 0 && _t(n, r, e, t), U && qe.render(e), gt(M, e, t);
			}
			V !== null && le === 0 && (X.updateMultisampleRenderTarget(V), X.updateRenderTargetMipmap(V)), r && te.end(L), e.isScene === !0 && e.onAfterRender(L, e, t), $e.resetDefaultState(), H = -1, ue = null, I.pop(), I.length > 0 ? (P = I[I.length - 1], X.setTextureUnits(P.state.textureUnits), Te === !0 && Ue.setGlobalState(L.clippingPlanes, P.state.camera)) : P = null, F.pop(), M = F.length > 0 ? F[F.length - 1] : null, ae !== null && ae.renderEnd();
		};
		function ht(e, t, n, r) {
		...
		function gt(e, t, n, r) {
			...
			P.setupLightsView(n), Te === !0 && Ue.setGlobalState(L.clippingPlanes, n), r && q.viewport(de.copy(r)), i.length > 0 && vt(i, t, n), a.length > 0 && vt(a, t, n), o.length > 0 && vt(o, t, n), q.buffers.depth.setTest(!0), q.buffers.depth.setMask(!0), q.buffers.color.setMask(!0), q.setPolygonOffset(!1);
		}
		function _t(e, t, n, r) {
			...
			if (P.state.transmissionRenderTarget[r.id] === void 0) {
				...
				P.state.transmissionRenderTarget[r.id] = new Ke(1, 1, {
					generateMipmaps: !0,
					type: e ? u : o,
					minFilter: a,
			...
			L.setRenderTarget(s), L.getClearColor(me), he = L.getClearAlpha(), he < 1 && L.setClearColor(16777215, .5), L.clear(), U && qe.render(n);
			let p = L.toneMapping;
			L.toneMapping = 0;
			let m = r.viewport;
			if (r.viewport !== void 0 && (r.viewport = void 0), P.setupLightsView(r), Te === !0 && Ue.setGlobalState(L.clippingPlanes, r), vt(e, n, r), X.updateMultisampleRenderTarget(s), X.updateRenderTargetMipmap(s), K.has("WEBGL_multisampled_render_to_texture") === !1) {
				let e = !1;
				for (let i = 0, a = t.length; i < a; i++) {
			...
			L.setRenderTarget(l, d, f), L.setClearColor(me, he), m !== void 0 && (r.viewport = m), L.toneMapping = p;
		}
		function vt(e, t, n) {
		...
		function bt(e, t, n) {
			...
			} else s.uniforms = ze.getUniforms(e), ae !== null && e.isNodeMaterial && ae.build(e, n, s), e.onBeforeCompile(s, L), d = ze.acquireProgram(s, c), l.set(c, d), r.uniforms = s.uniforms;
			let f = r.uniforms;
			return (!e.isShaderMaterial && !e.isRawShaderMaterial || e.clipping === !0) && (f.clippingPlanes = Ue.uniform), St(e, s), r.needsLights = Et(e), r.lightsStateVersion = o, r.needsLights && (f.ambientLightColor.value = i.state.ambient, f.lightProbe.value = i.state.probe, f.directionalLights.value = i.state.directional, f.directionalLightShadows.value = i.state.directionalShadow, f.spotLights.value = i.state.spot, f.spotLightShadows.value = i.state.spotShadow, f.rectAreaLights.value = i.state.rectArea, f.ltc_1.value = i.state.rectAreaLTC1, f.ltc_2.value = i.state.rectAreaLTC2, f.pointLights.value = i.state.point, f.pointLightShadows.value = i.state.pointShadow, f.hemisphereLights.value = i.state.hemi, f.directionalShadowMatrix.value = i.state.directionalShadowMatrix, f.spotLightMatrix.value = i.state.spotLightMatrix, f.spotLightMap.value = i.state.spotLightMap, f.pointShadowMatrix.value = i.state.pointShadowMatrix), r.lightProbeGrid = P.state.lightProbeGridArray.length > 0, r.currentProgram = d, r.uniformsList = null, d;
		}
		function xt(e) {
		...
		function wt(e, t, n, r, i) {
			...
			let a = t.fog, o = r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial ? t.environment : null, s = V === null ? L.outputColorSpace : V.isXRRenderTarget === !0 ? V.texture.colorSpace : Y.workingColorSpace, c = r.isMeshStandardMaterial || r.isMeshLambertMaterial && !r.envMap || r.isMeshPhongMaterial && !r.envMap, l = Fe.get(r.envMap || o, c), u = r.vertexColors === !0 && !!n.attributes.color && n.attributes.color.itemSize === 4, d = !!n.attributes.tangent && (!!r.normalMap || r.anisotropy > 0), f = !!n.morphAttributes.position, p = !!n.morphAttributes.normal, m = !!n.morphAttributes.color, h = 0;
			r.toneMapped && (V === null || V.isXRRenderTarget === !0) && (h = L.toneMapping);
			let g = n.morphAttributes.position || n.morphAttributes.normal || n.morphAttributes.color, _ = g === void 0 ? 0 : g.length, v = J.get(r), y = P.state.lights;
			if (Te === !0 && (Ee === !0 || e !== ue)) {
				let t = e === ue && r.id === H;
				Ue.setState(r, e, t);
			}
			...
			if (q.useProgram(x.program) && (S = !0, C = !0, w = !0), r.id !== H && (H = r.id, C = !0), v.needsLights) {
			...
			if ((D.position !== void 0 || D.normal !== void 0 || D.color !== void 0) && Je.update(i, n, x), (C || v.receiveShadow !== i.receiveShadow) && (v.receiveShadow = i.receiveShadow, T.setValue(G, "receiveShadow", i.receiveShadow)), (r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial) && r.envMap === null && t.environment !== null && (E.envMapIntensity.value = t.environmentIntensity), E.dfgLUT !== void 0 && (E.dfgLUT.value = ul()), C) {
				if (T.setValue(G, "toneMappingExposure", L.toneMappingExposure), v.needsLights && Tt(E, w), a && r.fog === !0 && Be.refreshFogUniforms(E, a), Be.refreshMaterialUniforms(E, r, ve, _e, P.state.transmissionRenderTarget[e.id]), v.needsLights && v.lightProbeGrid) {
				...
				Us.upload(G, xt(v), E, X);
			}
			if (r.isShaderMaterial && r.uniformsNeedUpdate === !0 && (Us.upload(G, xt(v), E, X), r.uniformsNeedUpdate = !1), r.isSpriteMaterial && T.setValue(G, "center", i.center), T.setValue(G, "modelViewMatrix", i.modelViewMatrix), T.setValue(G, "normalMatrix", i.normalMatrix), T.setValue(G, "modelMatrix", i.matrixWorld), r.uniformsGroups !== void 0) {
		...
		this.getActiveCubeFace = function() {
			...
			if (e) {
				...
				if (o.__useDefaultFramebuffer !== void 0) {
					q.bindFramebuffer(G.FRAMEBUFFER, o.__webglFramebuffer), de.copy(e.viewport), fe.copy(e.scissor), pe = e.scissorTest, q.viewport(de), q.scissor(fe), q.setScissorTest(pe), H = -1;
					return;
				...
				e.isWebGLCubeRenderTarget ? (r = Array.isArray(c[t]) ? c[t][n] : c[t], i = !0) : r = e.samples > 0 && X.useMultisampledRTT(e) === !1 ? J.get(e).__webglMultisampledFramebuffer : Array.isArray(c) ? c[n] : c, de.copy(e.viewport), fe.copy(e.scissor), pe = e.scissorTest;
			} else de.copy(xe).multiplyScalar(ve).floor(), fe.copy(Se).multiplyScalar(ve).floor(), pe = Ce;
			if (n !== 0 && (r = oe), q.bindFramebuffer(G.FRAMEBUFFER, r) && q.drawBuffers(e, r), q.viewport(de), q.scissor(fe), q.setScissorTest(pe), i) {
			...
			if (e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c) {
				...
				try {
					...
					if (e.textures.length > 1 && G.readBuffer(G.COLOR_ATTACHMENT0 + s), !Ne.textureFormatReadable(c)) {
					...
					t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i && G.readPixels(t, n, r, i, Qe.convert(c), Qe.convert(l), a);
				} finally {
					let e = V === null ? null : J.get(V).__webglFramebuffer;
			...
			if (e.isWebGLCubeRenderTarget && o !== void 0 && (c = c[o]), c) if (t >= 0 && t <= e.width - r && n >= 0 && n <= e.height - i) {
				...
				if (e.textures.length > 1 && G.readBuffer(G.COLOR_ATTACHMENT0 + s), !Ne.textureFormatReadable(l)) throw Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");
				...
				G.bindBuffer(G.PIXEL_PACK_BUFFER, d), G.bufferData(G.PIXEL_PACK_BUFFER, a.byteLength, G.STREAM_READ), G.readPixels(t, n, r, i, Qe.convert(l), Qe.convert(u), 0);
				let f = V === null ? null : J.get(V).__webglFramebuffer;
				q.bindFramebuffer(G.FRAMEBUFFER, f);
				let p = G.fenceSync(G.SYNC_GPU_COMMANDS_COMPLETE, 0);
				return G.flush(), await ie(G, p, 4), G.bindBuffer(G.PIXEL_PACK_BUFFER, d), G.getBufferSubData(G.PIXEL_PACK_BUFFER, 0, a), G.deleteBuffer(d), G.deleteSync(p), a;
			...
			if (e.isDepthTexture) {
				...
				q.bindFramebuffer(G.READ_FRAMEBUFFER, B), q.bindFramebuffer(G.DRAW_FRAMEBUFFER, se);
			...
			ce = 0, le = 0, V = null, q.reset(), $e.reset();
	...
	constructor({ scene: e, camera: t, renderer: n }) {
		this.scene = e, this.camera = t, this.renderer = n;
	}
}, pl = Object.freeze({
	container: null,
	alpha: !0,
	...
	constructor(e = {}) {
		...
		this.container = this.#s(t.container);
		let n = this.#n(t.background), r = this.#r(t), i = this.#i(t);
		this.#t = new fl({
			scene: n,
			camera: r,
			renderer: i
		}), this.lights = this.#a(), this.render = this.render.bind(this), this.resize = this.resize.bind(this), this.#t.scene.add(...this.lights), this.container.appendChild(this.#t.renderer.domElement), this.#e = this.resize, this.#l().addEventListener("resize", this.#e), this.resize();
	}
	get domElement() {
	...
	destroy() {
		this.#l().removeEventListener("resize", this.#e), this.renderer.dispose(), this.renderer.domElement.remove();
	}
	#n(e) {
		let t = new jt();
		return e !== null && (t.background = new Z(e)), t;
	}
	#r({ fov: e, near: t, far: n, cameraZ: r }) {
		let i = new Ca(e, this.aspect, t, n);
		return i.position.z = r, i;
	}
	#i({ alpha: e, antialias: t, pixelRatio: n }) {
		let r = new dl({
			alpha: e,
			antialias: t
		});
		return r.setPixelRatio(n ?? this.#l().devicePixelRatio ?? 1), r;
	}
	#a() {
		let e = new Da(16777215, 2), t = new Ea(16777215, 5);
		return t.position.set(100, 100, 200), [e, t];
	}
	#o() {
		let e = this.#l();
		return {
			width: this.container.clientWidth || e.innerWidth || 1,
			height: this.container.clientHeight || e.innerHeight || 1
		};
	}
	#s(e) {
		let t = this.#c(), n = t.body;
		if (e === null && n) return n;
		if (t.defaultView && e instanceof t.defaultView.HTMLElement) return e;
		throw Error(e === null ? "FlowFX Viewport requires a DOM container or document.body." : "FlowFX Viewport container must be an HTMLElement.");
	}
	#c() {
		if (typeof document > "u") throw Error("FlowFX Viewport requires a browser document.");
		return document;
	}
	#l() {
		if (typeof window > "u") throw Error("FlowFX Viewport requires a browser window.");
		return window;
	}
}, hl = "[data-ff=\"extrude\"]", gl = /* @__PURE__ */ new WeakMap();
async function _l(e, t = El()) {
	let n = bl(t);
	return (await Promise.allSettled(n.map((t) => vl(e, t)))).filter((e) => e.status === "fulfilled" && e.value).map((e) => e.value);
}
async function vl(e, t) {
	let n = gl.get(t);
	if (n) {
		let e = await n;
		if (!e || e.object.destroyed) gl.delete(t);
		else return e;
	}
	let r = xl(t);
	if (!r) return null;
	let i = yl(e, t, r).catch((e) => (gl.delete(t), Tl(t, `failed to mount: ${e.message}`), null));
	return gl.set(t, i), i;
}
async function yl(e, t, n) {
	let r = new e({ viewport: { container: t } });
	try {
		let e = await r.createExtrude(n);
		return r.start(), {
			element: t,
			flowfx: r,
			object: e
...
function bl(e) {
	let t = Array.from(e.querySelectorAll?.(hl) ?? []);
	return e.matches?.(hl) && t.unshift(e), t;
}
function xl(e) {
	let t = e.getAttribute("data-src");
	if (!t) return Tl(e, "missing required data-src attribute."), null;
	let n = { svg: t };
	return Sl(e, "data-depth", "depth", n), wl(e, "data-color", "color", n), Sl(e, "data-roughness", "roughness", n), Sl(e, "data-metalness", "metalness", n), Cl(e, "data-auto-rotate", "autoRotate", n), Sl(e, "data-rotation-speed", "rotationSpeed", n), n;
}
function Sl(e, t, n, r) {
	...
	if (!Number.isFinite(a)) {
		Tl(e, `ignored invalid ${t} value "${i}".`);
		return;
	}
	r[n] = a;
}
...
function Tl(e, t) {
	typeof console > "u" || console.warn("FlowFX Data API:", t, e);
}
function El() {
	if (typeof document > "u") throw Error("FlowFX.mountAll() requires a browser document.");
	return document;
}
//#endregion
//#region node_modules/three/examples/jsm/loaders/SVGLoader.js
var Dl = O, Ol = class e extends sa {
	constructor(e) {
		super(e), this.defaultDPI = 90, this.defaultUnit = "px";
	}
	load(e, t, n, r) {
		let i = this, a = new ua(i.manager);
	...
	parse(e) {
		...
		function n(e, t) {
			...
			e.hasAttribute("filter") && console.warn("THREE.SVGLoader: Filters are not supported.");
			let a = b(e), o = !1, p = null;
			switch (e.nodeName) {
				case "svg":
					t = m(e, t);
					break;
				...
				case "g":
					...
					break;
				case "path":
					t = m(e, t), e.hasAttribute("d") && (p = r(e));
					break;
				case "rect":
					t = m(e, t), p = s(e);
					break;
				...
				case "use":
					t = m(e, t);
					let a = (e.getAttributeNS("http://www.w3.org/1999/xlink", "href") || "").substring(1), h = e.viewportElement.getElementById(a);
					h ? n(h, t) : console.warn("SVGLoader: 'use node' references non-existent node id: " + a);
					break;
				default:
			}
			if (p) {
				t.fill !== void 0 && t.fill !== "none" && !t.fill.startsWith("url") && p.color.setStyle(t.fill, Dl), C(p, L), A.push(p);
				let n = Object.assign({}, t);
				n.strokeWidth = t.strokeWidth * O(L), p.userData = {
					node: e,
					style: n,
					transform: L.clone(),
					gradients: M
			...
			a && (N.pop(), N.length > 0 ? L.copy(N[N.length - 1]) : L.identity());
		}
		function r(e) {
			let t = new Ka(), n = new U(), r = new U(), i = new U(), o = !0, s = !1, c = e.getAttribute("d");
			...
			for (let e = 0, c = l.length; e < c; e++) {
				...
				switch (u) {
					...
					case "S":
						f = g(d);
						for (let e = 0, a = f.length; e < a; e += 4) t.bezierCurveTo(h(n.x, r.x), h(n.y, r.y), f[e + 0], f[e + 1], f[e + 2], f[e + 3]), r.x = f[e + 0], r.y = f[e + 1], n.x = f[e + 2], n.y = f[e + 3], e === 0 && s === !0 && i.copy(n);
						break;
					case "Q":
						f = g(d);
					...
					case "s":
						f = g(d);
						for (let e = 0, a = f.length; e < a; e += 4) t.bezierCurveTo(h(n.x, r.x), h(n.y, r.y), n.x + f[e + 0], n.y + f[e + 1], n.x + f[e + 2], n.y + f[e + 3]), r.x = n.x + f[e + 0], r.y = n.y + f[e + 1], n.x += f[e + 2], n.y += f[e + 3], e === 0 && s === !0 && i.copy(n);
						break;
					case "q":
						f = g(d);
		...
		function s(e) {
			let t = y(e.getAttribute("x") || 0), n = y(e.getAttribute("y") || 0), r = y(e.getAttribute("rx") || e.getAttribute("ry") || 0), i = y(e.getAttribute("ry") || e.getAttribute("rx") || 0), a = y(e.getAttribute("width")), o = y(e.getAttribute("height")), s = .448084975506, c = new Ka();
		...
		function c(e) {
			...
			let n = /([+-]?\d*\.?\d+(?:e[+-]?\d+)?)(?:,|\s)([+-]?\d*\.?\d+(?:e[+-]?\d+)?)/g, r = new Ka(), i = 0;
		...
		function u(e) {
			let t = y(e.getAttribute("cx") || 0), n = y(e.getAttribute("cy") || 0), r = y(e.getAttribute("r") || 0), i = new Hr();
			i.absarc(t, n, r, 0, Math.PI * 2);
			let a = new Ka();
			return a.subPaths.push(i), a;
		}
		function d(e) {
			let t = y(e.getAttribute("cx") || 0), n = y(e.getAttribute("cy") || 0), r = y(e.getAttribute("rx") || 0), i = y(e.getAttribute("ry") || 0), a = new Hr();
			a.absellipse(t, n, r, i, 0, Math.PI * 2);
			let o = new Ka();
			return o.subPaths.push(a), o;
		}
		function f(e) {
			let t = y(e.getAttribute("x1") || 0), n = y(e.getAttribute("y1") || 0), r = y(e.getAttribute("x2") || 0), i = y(e.getAttribute("y2") || 0), a = new Ka();
			return a.moveTo(t, n), a.lineTo(r, i), a.currentPath.autoClose = !1, a;
		}
		function p(e) {
			let t = e.querySelectorAll("linearGradient, radialGradient"), n = [
				"x1",
				"y1",
				"x2",
				"y2",
			...
			for (let e of t) {
				...
				if (!t) continue;
				let i = {
					type: e.nodeName === "radialGradient" ? "radialGradient" : "linearGradient",
					attrs: {},
					stops: null,
					href: null
				}, a = e.getAttributeNS("http://www.w3.org/1999/xlink", "href") || e.getAttribute("href") || "";
				a.startsWith("#") && (i.href = a.substring(1));
				for (let t of n) e.hasAttribute(t) && (i.attrs[t] = e.getAttribute(t));
				let o = e.querySelectorAll("stop");
				if (o.length > 0) {
					i.stops = [];
					for (let e of o) {
						let t = e.getAttribute("stop-color");
						!t && e.style && (t = e.style["stop-color"]), t ||= "#000";
						let n = e.getAttribute("stop-opacity");
						(n === null || n === "") && e.style && (n = e.style["stop-opacity"]), n = n === null || n === "" || n === void 0 ? 1 : Math.max(0, Math.min(1, parseFloat(n)));
						let r = Math.max(0, Math.min(1, parseFloat(e.getAttribute("offset") || "0")));
						i.stops.push({
							offset: r,
							color: t,
							opacity: n
			...
			function i(e, t) {
				let n = r[e];
				if (!n || t.has(e)) return n;
				if (t.add(e), n.href && r[n.href]) {
					let e = i(n.href, t);
					if (e) {
						n.stops ||= e.stops;
						for (let t in e.attrs) t in n.attrs || (n.attrs[t] = e.attrs[t]);
					}
				}
				return n;
			}
			for (let e in r) i(e, /* @__PURE__ */ new Set());
			for (let e in r) {
				let t = r[e], n = t.attrs, i = n.gradientUnits === "userSpaceOnUse" ? "userSpaceOnUse" : "objectBoundingBox", a = {
					type: t.type,
					gradientUnits: i,
					spreadMethod: n.spreadMethod === "reflect" || n.spreadMethod === "repeat" ? n.spreadMethod : "pad",
					gradientTransform: null,
					stops: (t.stops || []).slice().sort((e, t) => e.offset - t.offset)
				};
				n.gradientTransform && (a.gradientTransform = new K(), S(n.gradientTransform, a.gradientTransform));
				function o(e) {
					return typeof e == "string" ? e.endsWith("%") ? parseFloat(e) / 100 : y(e) : 0;
				}
				if (t.type === "linearGradient") a.x1 = n.x1 === void 0 ? 0 : o(n.x1), a.y1 = n.y1 === void 0 ? 0 : o(n.y1), a.x2 = n.x2 === void 0 ? +(i === "objectBoundingBox") : o(n.x2), a.y2 = n.y2 === void 0 ? 0 : o(n.y2);
				else {
					let e = i === "objectBoundingBox" ? .5 : 0, t = i === "objectBoundingBox" ? .5 : 0;
					a.cx = n.cx === void 0 ? e : o(n.cx), a.cy = n.cy === void 0 ? e : o(n.cy), a.r = n.r === void 0 ? t : o(n.r), a.fx = n.fx === void 0 ? a.cx : o(n.fx), a.fy = n.fy === void 0 ? a.cy : o(n.fy);
				}
				M[e] = a;
			}
		}
		function m(e, t) {
			...
			if (e.hasAttribute("class")) {
				...
				for (let e = 0; e < t.length; e++) n = Object.assign(n, j["." + t[e]]);
			}
			e.hasAttribute("id") && (n = Object.assign(n, j["#" + e.getAttribute("id")]));
			function r(r, i, a) {
			...
			function i(e) {
				return Math.max(0, Math.min(1, y(e)));
			}
			function a(e) {
		...
		function y(e) {
			let n = "px";
			if (typeof e == "string" || e instanceof String) for (let t = 0, r = _.length; t < r; t++) {
				let r = _[t];
				if (e.endsWith(r)) {
			...
			let r;
			return n === "px" && t.defaultUnit !== "px" ? r = v.in[t.defaultUnit] / t.defaultDPI : (r = v[n][t.defaultUnit], r < 0 && (r = v[n].in * t.defaultDPI)), r * parseFloat(e);
		}
		function b(e) {
			if (!(e.hasAttribute("transform") || e.nodeName === "use" && (e.hasAttribute("x") || e.hasAttribute("y")))) return null;
			let t = x(e);
			return N.length > 0 && t.premultiply(N[N.length - 1]), L.copy(t), N.push(t), t;
		}
		function x(e) {
			let t = new K();
			if (e.nodeName === "use" && (e.hasAttribute("x") || e.hasAttribute("y"))) {
				let n = y(e.getAttribute("x") || 0), r = y(e.getAttribute("y") || 0);
				t.makeTranslation(n, r);
			}
			return e.hasAttribute("transform") && S(e.getAttribute("transform"), t), t;
		}
		function S(e, t) {
			let n = P, r = e.split(")");
			for (let e = r.length - 1; e >= 0; e--) {
				...
				if (a > 0 && a < o) {
					let e = i.slice(0, a), r = g(i.slice(a + 1));
					switch (n.identity(), e) {
						case "translate":
							if (r.length >= 1) {
								let e = r[0], t = 0;
								r.length >= 2 && (t = r[1]), n.makeTranslation(e, t);
							}
							break;
						case "rotate":
							if (r.length >= 1) {
								let e = 0, t = 0, i = 0;
								e = r[0] * Math.PI / 180, r.length >= 3 && (t = r[1], i = r[2]), F.makeTranslation(-t, -i), I.makeRotation(e), ee.multiplyMatrices(I, F), F.makeTranslation(t, i), n.multiplyMatrices(F, ee);
							}
							break;
						case "scale":
							if (r.length >= 1) {
								let e = r[0], t = e;
								r.length >= 2 && (t = r[1]), n.makeScale(e, t);
							}
							break;
						case "skewX":
		...
		function C(e, t) {
			function n(e) {
				ne.set(e.x, e.y, 1).applyMatrix3(t), e.set(ne.x, ne.y);
			}
			function r(e) {
				let n = e.xRadius, r = e.yRadius, i = Math.cos(e.aRotation), a = Math.sin(e.aRotation), o = new W(n * i, n * a, 0), s = new W(-r * a, r * i, 0), c = o.applyMatrix3(t), l = s.applyMatrix3(t), u = P.set(c.x, l.x, 0, c.y, l.y, 0, 0, 0, 1), d = F.copy(u).invert(), f = I.copy(d).transpose().multiply(d).elements, p = k(f[0], f[1], f[4]), m = Math.sqrt(p.rt1), h = Math.sqrt(p.rt2);
				if (e.xRadius = 1 / m, e.yRadius = 1 / h, e.aRotation = Math.atan2(p.sn, p.cs), !((e.aEndAngle - e.aStartAngle) % (2 * Math.PI) < 2 ** -52)) {
					let n = F.set(m, 0, 0, 0, h, 0, 0, 0, 1), r = I.set(p.cs, p.sn, 0, -p.sn, p.cs, 0, 0, 0, 1), i = n.multiply(r).multiply(u), a = (e) => {
						let { x: t, y: n } = new W(Math.cos(e), Math.sin(e), 0).applyMatrix3(i);
						return Math.atan2(n, t);
					};
					e.aStartAngle = a(e.aStartAngle), e.aEndAngle = a(e.aEndAngle), w(t) && (e.aClockwise = !e.aClockwise);
				}
			}
			function i(e) {
				let n = E(t), r = D(t);
				...
				e.aRotation += i, w(t) && (e.aStartAngle *= -1, e.aEndAngle *= -1, e.aClockwise = !e.aClockwise);
			}
			let a = e.subPaths;
			for (let e = 0, o = a.length; e < o; e++) {
				...
				for (let e = 0; e < o.length; e++) {
					let a = o[e];
					a.isLineCurve ? (n(a.v1), n(a.v2)) : a.isCubicBezierCurve ? (n(a.v0), n(a.v1), n(a.v2), n(a.v3)) : a.isQuadraticBezierCurve ? (n(a.v0), n(a.v1), n(a.v2)) : a.isEllipseCurve && (te.set(a.aX, a.aY), n(te), a.aX = te.x, a.aY = te.y, T(t) ? r(a) : i(a));
				}
			}
		}
		function w(e) {
		...
		function O(e) {
			let t = e.elements, n = t[0] * t[4] - t[1] * t[3];
		...
		let A = [], j = {}, M = {}, N = [], P = new K(), F = new K(), I = new K(), ee = new K(), te = new U(), ne = new W(), L = new K(), R = new DOMParser().parseFromString(e, "image/svg+xml");
		return p(R), n(R.documentElement, {
			fill: "#000",
			fillOpacity: 1,
			strokeOpacity: 1,
			strokeWidth: 1,
			...
			paths: A,
			gradients: M,
			xml: R.documentElement
		};
	}
	static createFillMaterial(e) {
		let t = e.userData.style;
		if (t.fill === void 0 || t.fill === "none") return null;
		let n = e.color, r = null, i = kl.exec(t.fill);
		i && (r = Al(e.userData.gradients && e.userData.gradients[i[1]], e));
		let a = new Ln({
			opacity: t.fillOpacity * (t.opacity || 1),
			transparent: !0,
			side: 2,
			depthWrite: !1
		});
		return r === null ? a.color = n : a.map = r, a;
	}
	static createStrokeMaterial(e) {
		let t = e.userData.style;
		return t.stroke === void 0 || t.stroke === "none" ? null : (kl.test(t.stroke) && console.warn("THREE.SVGLoader: Gradient strokes are not supported."), new Ln({
			color: new Z().setStyle(t.stroke, Dl),
			opacity: t.strokeOpacity * (t.opacity || 1),
			transparent: !0,
			side: 2,
			depthWrite: !1
		}));
	...
	static createShapes(e) {
		return console.warn("SVGLoader: createShapes() is deprecated. Use shapePath.toShapes() instead."), e.toShapes();
	}
	...
	static pointsToStroke(t, n, r, i) {
		...
		let c = new En();
		return c.setAttribute("position", new mn(a, 3)), c.setAttribute("normal", new mn(o, 3)), c.setAttribute("uv", new mn(s, 2)), c;
	}
	static pointsToStrokeWithBuffers(e, t, n, r, i, a, o, s) {
		let c = new U(), l = new U(), u = new U(), d = new U(), f = new U(), p = new U(), m = new U(), h = new U(), g = new U(), _ = new U(), v = new U(), y = new U(), b = new U(), x = new U(), S = new U(), C = new U(), w = new U();
		n = n === void 0 ? 12 : n, r = r === void 0 ? .001 : r, s = s === void 0 ? 0 : s, e = se(e);
		let T = e.length;
		if (T < 2) return 0;
		let E = e[0].equals(e[T - 1]), D, O = e[0], k, A = t.strokeWidth / 2, j = 1 / (T - 1), M = 0, N, P, F, I, ee = !1, te = 0, ne = s * 3, L = s * 2;
		R(e[0], e[1], c).multiplyScalar(A), h.copy(e[0]).sub(c), g.copy(e[0]).add(c), _.copy(h), v.copy(g);
		for (let n = 1; n < T; n++) {
			D = e[n], k = n === T - 1 ? E ? e[1] : void 0 : e[n + 1];
			let r = c;
			if (R(O, D, r), u.copy(r).multiplyScalar(A), y.copy(D).sub(u), b.copy(D).add(u), N = M + j, P = !1, k !== void 0) {
				R(D, k, l), u.copy(l).multiplyScalar(A), x.copy(D).sub(u), S.copy(D).add(u), F = !0, u.subVectors(k, O), r.dot(u) < 0 && (F = !1), n === 1 && (ee = F), u.subVectors(k, D), u.normalize();
				let e = Math.abs(r.dot(u));
				if (e > 2 ** -52) {
					let n = A / e;
					u.multiplyScalar(-n), d.subVectors(D, O), f.copy(d).setLength(n).add(u), C.copy(f).negate();
					let r = f.length(), i = d.length();
					d.divideScalar(i), p.subVectors(k, D);
					let a = p.length();
					if (p.divideScalar(a), d.dot(C) < i && p.dot(C) < a && (P = !0), w.copy(f).add(D), C.add(D), P) {
						let e = F ? g : h, t = (w.x - e.x) * (C.y - e.y) - (w.y - e.y) * (C.x - e.x);
						(F && t < 0 || !F && t > 0) && C.copy(e);
					}
					switch (I = !1, P ? F ? (S.copy(C), b.copy(C)) : (x.copy(C), y.copy(C)) : ie(), t.strokeLineJoin) {
						case "bevel":
							ae(F, P, N);
							break;
						case "round":
							oe(F, P), F ? re(D, y, x, N, 0) : re(D, S, b, N, 1);
							break;
						default:
							...
							if (e < 1) if (t.strokeLineJoin !== "miter-clip") {
								ae(F, P, N);
								break;
							} else oe(F, P), F ? (p.subVectors(w, y).multiplyScalar(e).add(y), m.subVectors(w, x).multiplyScalar(e).add(x), z(y, N, 0), z(p, N, 0), z(D, N, .5), z(D, N, .5), z(p, N, 0), z(m, N, 0), z(D, N, .5), z(m, N, 0), z(x, N, 0)) : (p.subVectors(w, b).multiplyScalar(e).add(b), m.subVectors(w, S).multiplyScalar(e).add(S), z(b, N, 1), z(p, N, 1), z(D, N, .5), z(D, N, .5), z(p, N, 1), z(m, N, 1), z(D, N, .5), z(m, N, 1), z(S, N, 1));
							else P ? (F ? (z(g, M, 1), z(h, M, 0), z(w, N, 0), z(g, M, 1), z(w, N, 0), z(C, N, 1)) : (z(g, M, 1), z(h, M, 0), z(w, N, 1), z(h, M, 0), z(C, N, 0), z(w, N, 1)), F ? x.copy(w) : S.copy(w)) : F ? (z(y, N, 0), z(w, N, 0), z(D, N, .5), z(D, N, .5), z(w, N, 0), z(x, N, 0)) : (z(b, N, 1), z(w, N, 1), z(D, N, .5), z(D, N, .5), z(w, N, 1), z(S, N, 1)), I = !0;
							break;
					}
				} else ie();
			} else ie();
			!E && n === T - 1 && B(e[0], _, v, F, !0, M), M = N, O = D, h.copy(x), g.copy(S);
		}
		if (!E) B(D, y, b, F, !1, N);
		else if (P && i) {
			let e = w, t = C;
			ee !== F && (e = C, t = w), F ? (I || ee) && (t.toArray(i, 0), t.toArray(i, 9), I && e.toArray(i, 3)) : (I || !ee) && (t.toArray(i, 3), t.toArray(i, 9), I && e.toArray(i, 0));
		}
		if (i) {
			let e = [
				new U(),
			...
			for (let n = t; n < ne; n += 9) e[0].set(i[n], i[n + 1]), e[1].set(i[n + 3], i[n + 4]), e[2].set(i[n + 6], i[n + 7]), wi.area(e) < 0 && (i[n + 3] = e[0].x, i[n + 4] = e[0].y);
		}
		return te;
		function R(e, t, n) {
		...
		function z(e, t, n) {
			i && (i[ne] = e.x, i[ne + 1] = e.y, i[ne + 2] = 0, a && (a[ne] = 0, a[ne + 1] = 0, a[ne + 2] = 1), ne += 3, o && (o[L] = t, o[L + 1] = n, L += 2)), te += 3;
		}
		function re(e, t, r, i, a) {
			...
			for (let t = 0, r = n - 1; t < r; t++) d.copy(u).rotateAround(e, o), z(u, i, a), z(d, i, a), z(e, i, .5), u.copy(d);
			z(u, i, a), z(r, i, a), z(e, i, .5);
		}
		function ie() {
			z(g, M, 1), z(h, M, 0), z(y, N, 0), z(g, M, 1), z(y, N, 0), z(b, N, 1);
		}
		function ae(e, t, n) {
			t ? e ? (z(g, M, 1), z(h, M, 0), z(y, N, 0), z(g, M, 1), z(y, N, 0), z(C, N, 1), z(y, n, 0), z(x, n, 0), z(C, n, .5)) : (z(g, M, 1), z(h, M, 0), z(b, N, 1), z(h, M, 0), z(C, N, 0), z(b, N, 1), z(b, n, 1), z(C, n, 0), z(S, n, 1)) : e ? (z(y, n, 0), z(x, n, 0), z(D, n, .5)) : (z(b, n, 1), z(S, n, 0), z(D, n, .5));
		}
		function oe(e, t) {
			t && (e ? (z(g, M, 1), z(h, M, 0), z(y, N, 0), z(g, M, 1), z(y, N, 0), z(C, N, 1), z(y, M, 0), z(D, N, .5), z(C, N, 1), z(D, N, .5), z(x, M, 0), z(C, N, 1)) : (z(g, M, 1), z(h, M, 0), z(b, N, 1), z(h, M, 0), z(C, N, 0), z(b, N, 1), z(b, M, 1), z(C, N, 0), z(D, N, .5), z(D, N, .5), z(C, N, 0), z(S, M, 1)));
		}
		function B(e, n, r, a, s, f) {
			switch (t.strokeLineCap) {
				case "round":
					s ? re(e, r, n, f, .5) : re(e, n, r, f, .5);
					break;
				case "square":
...
}, kl = /^\s*url\(\s*(?:["']\s*)?#([^)'"\s]+)(?:\s*["'])?\s*\)\s*$/;
function Al(r, i, a = 256) {
	if (!r || !Array.isArray(r.stops) || r.stops.length === 0) return null;
	let o = i.userData.transform, s = r.gradientUnits === "objectBoundingBox", c = null;
	if (s && (c = jl(i, o), c === null)) return null;
	function l(e, t, n) {
		n.set(e, t, 1), r.gradientTransform && n.applyMatrix3(r.gradientTransform), s && n.set(c.minX + n.x * c.width, c.minY + n.y * c.height, 1), o && n.applyMatrix3(o);
	}
	let u = document.createElement("canvas"), d;
	if (r.type === "linearGradient") {
		u.width = a, u.height = 1;
		let e = u.getContext("2d"), t = e.createLinearGradient(0, 0, a, 0);
		Ml(t, r.stops), e.fillStyle = t, e.fillRect(0, 0, a, 1);
		let n = new W(), i = new W();
		l(r.x1, r.y1, n), l(r.x2, r.y2, i);
		let o = i.x - n.x, s = i.y - n.y, c = o * o + s * s || 1e-20, f = o / c, p = s / c, m = -(f * n.x + p * n.y);
		d = new K().set(f, p, m, 0, 0, .5, 0, 0, 1);
	} else {
		let e = r.cx, t = r.cy, n = r.fx, i = r.fy, l = r.r;
		if (r.gradientTransform) {
			let a = new W();
			a.set(e, t, 1).applyMatrix3(r.gradientTransform), e = a.x, t = a.y, a.set(n, i, 1).applyMatrix3(r.gradientTransform), n = a.x, i = a.y;
		}
		if (s && (e = c.minX + e * c.width, t = c.minY + t * c.height, n = c.minX + n * c.width, i = c.minY + i * c.height, l *= Math.sqrt((c.width * c.width + c.height * c.height) / 2)), l <= 0) return null;
		u.width = a, u.height = a;
		let f = u.getContext("2d"), p = e - l, m = t - l, h = 2 * l, g = a / h;
		f.setTransform(g, 0, 0, g, -p * g, -m * g);
		let _ = f.createRadialGradient(n, i, 0, e, t, l);
		Ml(_, r.stops), f.fillStyle = _, f.fillRect(p, m, h, h);
		let v = o ? o.clone().invert() : new K();
		d = new K().set(1 / h, 0, -p / h, 0, 1 / h, -m / h, 0, 0, 1).multiply(v);
	}
	let f = new cr(u);
	f.colorSpace = Dl, f.flipY = !1, f.matrixAutoUpdate = !1, f.matrix = d;
	let p = r.spreadMethod === "reflect" ? n : r.spreadMethod === "repeat" ? e : t;
	return f.wrapS = p, f.wrapT = p, f;
}
function jl(e, t) {
	let n = t ? t.clone().invert() : null, r = new U(), i = new Ga();
	for (let t of e.subPaths) for (let e of t.getPoints()) r.copy(e), n && r.applyMatrix3(n), i.expandByPoint(r);
	return i.isEmpty() ? null : {
		minX: i.min.x,
		minY: i.min.y,
...
function Ml(e, t) {
	...
	for (let r of t) {
		let t = r.color;
		if (r.opacity < 1) {
			n.setStyle(r.color, Dl);
			let e = /rgb\(([^)]+)\)/.exec(n.getStyle(Dl));
			e && (t = `rgba(${e[1]},${r.opacity})`);
		}
		e.addColorStop(Math.max(0, Math.min(1, r.offset)), t);
	}
}
//#endregion
//#region src/core/BaseObject.js
var Nl = class {
	constructor(e, t = {}) {
		this.context = e, this.viewport = e, this.options = t, this.object = null, this.loaded = !1, this.destroyed = !1;
	}
	async init() {
		return this.#e(), this.loaded ? this : (await this.onInit(), this.attach(), this.loaded = !0, this);
	}
	update(e = 0) {
		!this.loaded || this.destroyed || this.onUpdate(e);
	}
	destroy() {
		this.destroyed ||= (this.detach(), this.onDestroy(), this.loaded = !1, !0);
	}
	attach() {
		this.object && this.context.scene.add(this.object);
	}
	detach() {
		this.object && this.context.scene.remove(this.object);
	}
	onInit() {}
	onUpdate(e) {}
	onDestroy() {}
	#e() {
		if (this.destroyed) throw Error("FlowFX object cannot be used after destroy().");
	}
}, Pl = class {
	static createStandardMaterial({ color: e, roughness: t, metalness: n }) {
		return new Vi({
			color: e,
			roughness: t,
			metalness: n
	...
	rotationSpeed: .01,
	fitOffset: 1.15
}), Il = class e extends Nl {
	constructor(t, n = {}) {
		let r = e.#g(n);
		super(t, r), this.options = r, this._svg = r.svg, this._depth = r.depth, this._color = r.color, this._roughness = r.roughness, this._metalness = r.metalness, this._autoRotate = r.autoRotate, this._rotationSpeed = r.rotationSpeed, this._fitOffset = r.fitOffset, this._geometryDirty = !1, this._materialDirty = !1, this.loader = new Ol(), this.group = new Ct(), this.pivot = new Ct(), this.material = null, this.shapes = [], this.object = this.pivot, this.rotation.set(r.rotation.x, r.rotation.y, r.rotation.z);
	}
	async onInit() {
		let e = await this.#h();
		this.#e(e), this.#l(this.pivot, this._fitOffset), this._geometryDirty = !1, this._materialDirty = !1;
	}
	load() {
		return this.init();
	}
	onUpdate() {
		this._geometryDirty &&= (this.#o(), this.#c(), this.#l(this.pivot, this._fitOffset), !1), this._materialDirty &&= (this.#s(), !1), this._autoRotate && (this.pivot.rotation.y += this._rotationSpeed);
	}
	onDestroy() {
		this.#u(this.group), this.group.clear(), this.pivot.clear();
	}
	get rotation() {
		return this.pivot.rotation;
	}
	set rotation(e) {
		this.#m(this.pivot.rotation, e);
	}
	get position() {
		return this.pivot.position;
	}
	set position(e) {
		this.#m(this.pivot.position, e);
	}
	get scale() {
		return this.pivot.scale;
	}
	set scale(e) {
		this.#m(this.pivot.scale, e);
	}
	get depth() {
		return this._depth;
	}
	set depth(e) {
		e !== this._depth && (this._depth = e, this._geometryDirty = !0);
	}
	get color() {
		return this._color;
	}
	set color(e) {
		this._color = e, this._materialDirty = !0;
	}
	get roughness() {
		return this._roughness;
	}
	set roughness(e) {
		e !== this._roughness && (this._roughness = e, this._materialDirty = !0);
	}
	get metalness() {
		return this._metalness;
	}
	set metalness(e) {
		e !== this._metalness && (this._metalness = e, this._materialDirty = !0);
	}
	get autoRotate() {
	...
	set rotationSpeed(e) {
		this._rotationSpeed = e;
	}
	#e(e) {
		this.#_(e), this.shapes = this.#t(e.paths), this.material = this.#a(), this.#n(), this.#c(), this.pivot.add(this.group);
	}
	#t(e) {
		return e.flatMap((e) => e.toShapes(!0));
	}
	#n() {
		this.shapes.forEach((e) => {
			this.group.add(this.#r(e));
		});
	}
	#r(e) {
		let t = new Yn(this.#i(e), this.material);
		return t.userData.flowfxShape = e, t;
	}
	#i(e) {
		return new Di(e, {
			depth: this._depth,
	...
	#a() {
		return Pl.createStandardMaterial({
			color: this._color,
	...
	#o() {
		this.#f().forEach((e) => {
			let t = e.userData.flowfxShape, n = this.#i(t), r = e.geometry;
			e.geometry = n, r?.dispose();
		});
	}
	#s() {
		this.material && (this.material.color.set(this._color), this.material.roughness = this._roughness, this.material.metalness = this._metalness, this.material.needsUpdate = !0);
	}
	#c() {
		this.group.scale.y = -Math.abs(this.group.scale.y), this.group.position.set(0, 0, 0);
		let e = this.#p().getCenter(new W());
		this.group.position.set(-e.x * this.group.scale.x, -e.y * this.group.scale.y, -e.z * this.group.scale.z);
	}
	#l(e, t) {
		let n = new Kt().setFromObject(e).getBoundingSphere(new vn()), r = this.context.camera, i = Ae.degToRad(r.fov), a = n.radius / Math.sin(i / 2) * t;
		r.position.set(n.center.x, n.center.y, a), r.lookAt(n.center), r.near = Math.max(a / 100, .1), r.far = a * 100, r.updateProjectionMatrix();
	}
	#u(e) {
		let t = /* @__PURE__ */ new Set();
		e.traverse((e) => {
			e.isMesh && (e.geometry?.dispose(), this.#d(e.material, t));
	...
	#f() {
		return this.group.children.filter((e) => e.isMesh);
	}
	#p() {
		let e = new Kt();
		return this.#f().forEach((t) => {
			t.geometry.computeBoundingBox(), e.union(t.geometry.boundingBox);
		}), e;
	}
	#m(e, t) {
		t && (typeof t.x == "number" && (e.x = t.x), typeof t.y == "number" && (e.y = t.y), typeof t.z == "number" && (e.z = t.z));
	}
	#h() {
		return new Promise((e, t) => {
			this.loader.load(this._svg, e, void 0, t);
		});
	}
	static #g(e) {
		return {
	...
	#_(e) {
		if (!e?.paths?.length) throw Error("FlowFX Extrude could not generate geometry from an empty SVG.");
	}
}, Ll = class e {
	constructor({ viewport: e = {} } = {}) {
		this.viewport = new ml(e), this.objects = /* @__PURE__ */ new Set(), this.animationFrame = null;
	}
	async createExtrude(e) {
		let t = new Il(this.viewport.context, e);
		return await t.init(), this.objects.add(t), t;
	}
	add(e) {
		return this.objects.add(e), e;
	}
	remove(e) {
	...
	start() {
		...
		let e = () => {
			this.animationFrame = requestAnimationFrame(e), this.render();
		};
		e();
	}
	stop() {
	...
	destroy() {
		this.stop(), this.objects.forEach((e) => {
			e.destroy?.();
		}), this.objects.clear(), this.viewport.destroy();
	}
	static mountAll(t) {
		return _l(e, t);
	}
};
Ll.Extrude = Il, Ll.MaterialFactory = Pl, Ll.Viewport = ml;
//#endregion
